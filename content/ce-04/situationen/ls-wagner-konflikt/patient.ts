...
export const CE04_SIT_WAGNER_PATIENT: PatientBeschreibung = {
  ...
  hintergrund:
    "Frau Wagner ist nach der operativen Versorgung einer Schenkelhalsfraktur (hüftgelenksnah) auf Station. Ihr Sohn Thomas (54) besucht sie täglich. Er ist berufstätig, kümmert sich zusätzlich um den Haushalt seiner Mutter und ist seit Wochen erschöpft und in Sorge. Heute findet er seine Mutter im durchnässten Bett vor, weil die Klingel außer Reichweite lag — und platzt heraus.",
  hintergrundB1:
    "Frau Wagner ist nach einer Operation am Oberschenkelhals (nahe der Hüfte) auf Station. Ihr Sohn Thomas (54) kommt jeden Tag. Er arbeitet, kümmert sich um den Haushalt der Mutter und ist seit Wochen erschöpft und in Sorge. Heute findet er das Bett nass vor, weil die Klingel zu weit weg lag — und wird laut.",
  persoenlichkeit:
