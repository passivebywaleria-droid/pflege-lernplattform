...
export const CE04_THEMA_KULTURSENSIBLE_KOMMUNIKATION_BAUSTEINE: Wissensbaustein[] = [
  ...
  // ═══════════════════════════════════════════
  {
    ...
    stufe1: {
      typ: "denkfrage",
      frage:
        "Du fragst einen Patienten direkt: 'Haben Sie Schmerzen?' Er sagt 'Es geht schon' und lächelt — verneint aber nicht wirklich. Eine deutsche Kollegin hätte klar 'Ja' oder 'Nein' gesagt. Was ist hier los?",
      antwort:
        "Hier treffen direkte und indirekte Kommunikationsstile aufeinander. Manche Sprachen/Kulturen sind direkt (inhaltsorientiert, Ich-bezogen — z.B. Deutsch), andere indirekt (auf das Gegenüber orientiert, höflich umschreibend, um das 'Gesicht zu wahren'). 'Es geht schon' kann indirekt durchaus Schmerz bedeuten. Wer den Stil nicht erkennt, überhört wichtige Botschaften. (Kommunikation im Gesundheitswesen, Kap. 1; I Care)",
    },
    stufe2: {
      typ: "hinweis",
      text: "Kulturen/Sprachen unterscheiden sich im Kommunikationsstil: Direkte Kommunikation ist inhaltsorientiert und Ich-bezogen, sagt Dinge klar und unverblümt (z.B. Deutsch). Indirekte Kommunikation ist auf das Gegenüber/den Adressaten orientiert, umschreibt höflich, vermeidet offene Ablehnung, um das 'Gesicht zu wahren'. In der Pflege wichtig: indirekte Aussagen ('Es geht schon') ernst nehmen, nonverbale Zeichen beachten, behutsam nachfragen — nicht nur die Worte werten. (Kommunikation im Gesundheitswesen, Kap. 1)",
      textB1:
        "Menschen reden unterschiedlich direkt. Direkte Kommunikation sagt klar, was Sache ist (z.B. typisch Deutsch). Indirekte Kommunikation umschreibt höflich und vermeidet ein offenes 'Nein', um niemanden zu beschämen ('das Gesicht wahren'). In der Pflege: Nimm indirekte Aussagen wie 'Es geht schon' ernst, achte auf die Körpersprache und frag behutsam nach.",
    },
    stufe3: {
      typ: "erklaerung",
      step: {
  ...
  // ═══════════════════════════════════════════
  {
    ...
    stufe3: {
      ...
      step: {
        ...
        bloomLevel: 2,
        kompetenzbereich: "II.1",
        quellen: ["I Care Pflege (Demenz – pflegende Angehörige; Beratungs-, Entlastungs- und Selbsthilfeangebote; Pflegestützpunkte, Deutsche Alzheimer Gesellschaft)"],
        track: "basis",
        modus: "entdecker",
