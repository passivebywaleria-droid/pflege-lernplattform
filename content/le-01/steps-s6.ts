...
export const STEPS_S6: ContentStep[] = [
  ...
  // =============================================================
  {
    ...
    question: {
      ...
      dialogLines: [
        { speaker: "Kollegin Sabine", text: "Rivanol auf die Wunde — das machen wir hier seit 20 Jahren so." },
        { speaker: "Praxisanleiterin", text: "Aber die Forschung zeigt, dass Rivanol die Wundheilung sogar verzögern kann." },
        { speaker: "Kollegin Sabine", text: "Forschung hin oder her — bei meinen Patienten hat es immer funktioniert." },
        { speaker: "Praxisanleiterin", text: "Genau das ist das Problem: 'Es hat immer funktioniert' ist kein Beweis. Wir brauchen Evidenz — nicht Gewohnheit." },
      ],
    },
  },
  ...
  // =============================================================
  {
    ...
    question: {
      ...
      dialogLines: [
        { speaker: "Yasemin", text: "Frau Krüger war letzte Woche stabil, jetzt geht es ihr wieder schlechter. Gibt es ein Muster?" },
        { speaker: "Praxisanleiterin", text: "Ja — das beschreibt das Trajekt-Modell von Corbin und Strauss. Chronische Krankheiten verlaufen in Phasen." },
        { speaker: "Yasemin", text: "Was bedeutet das für unsere Pflege?" },
        { speaker: "Praxisanleiterin", text: "Wir begleiten die Patientin durch alle Phasen — stabil, instabil, Krise, Erholung. Die Pflege passt sich der jeweiligen Phase an." },
      ],
    },
  },
