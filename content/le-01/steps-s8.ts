...
export const STEPS_S8: ContentStep[] = [
  ...
  // =============================================================
  {
    ...
    question: {
      ...
      dialogPhases: [
        {
          context: "Die Ärztin kommt auf die Station und sagt: 'Frau Weber hat sich heute zum dritten Mal den Venenzugang gezogen. Ich ordne eine Fixierung der Hände an.' Du bist Yasemin und hörst das. Was sagst du?",
          contextB1: "Die Ärztin sagt: 'Frau Weber zieht sich die Nadel immer raus. Wir müssen ihre Hände festbinden.' Was sagst du?",
          speaker: "Ärztin",
          options: [
            {
              text: "Fixierung ist ein schwerer Eingriff in die Freiheitsrechte. Gibt es Alternativen, die wir zuerst versuchen können?",
              textB1: "Das ist ein großer Eingriff. Können wir zuerst etwas anderes versuchen?",
              patientResponse: "Was schwebt Ihnen denn vor? Wir brauchen den Zugang für die Antibiotika.",
              patientResponseB1: "Was möchten Sie versuchen? Sie braucht die Antibiotika.",
              score: 3,
              feedback: "Sehr gut! Du erkennst die ethische Dimension und fragst nach Alternativen. Fixierung ist laut PflBG ein letztes Mittel — Alternativen wie Ablenkung, Verbandsschutz oder Begleitung sollten zuerst versucht werden.",
              feedbackB1: "Sehr gut! Du fragst nach anderen Möglichkeiten. Fixierung soll nur der letzte Weg sein.",
            },
            {
              text: "Brauchen wir dafür nicht eine richterliche Genehmigung?",
              textB1: "Brauchen wir nicht eine Genehmigung vom Gericht?",
              patientResponse: "In einer akuten Notsituation können wir zunächst handeln. Aber ja, grundsätzlich brauchen wir eine richterliche Genehmigung.",
              patientResponseB1: "Im Notfall geht es erst mal ohne. Aber normalerweise brauchen wir eine Genehmigung.",
              score: 2,
              feedback: "Richtig erkannt! Die rechtliche Frage ist wichtig. Allerdings fehlt die ethische Perspektive — Frau Weber hat Demenz und wird die Fixierung nicht verstehen. Frage auch nach Alternativen.",
              feedbackB1: "Gute Frage! Aber denk auch daran: Frau Weber versteht nicht, warum man ihre Hände festhält. Das macht ihr Angst.",
            },
            {
              text: "Okay, dann bereite ich die Fixierung vor.",
              textB1: "Gut, ich mache das fertig.",
              patientResponse: "Danke. Die Handschuhe und Gurte sind im Schrank.",
              patientResponseB1: "Danke. Die Sachen sind im Schrank.",
              score: 1,
              feedback: "Vorsicht! Du akzeptierst die Anordnung ohne zu hinterfragen. Als Pflegefachperson hast du die Pflicht, ethische Bedenken zu äußern. Frau Weber hat ein Recht auf Würde und Freiheit — Fixierung darf nur das letzte Mittel sein.",
              feedbackB1: "Stopp! Du musst nachfragen. Fixierung ist ein großer Eingriff. Frag immer zuerst nach Alternativen.",
            },
          ],
        },
        {
          context: "Die Praxisanleiterin nimmt dich zur Seite: 'Gut, dass du nachgefragt hast. Was denkst du — welches ethische Prinzip steht hier im Konflikt?'",
          contextB1: "Die Praxisanleiterin fragt dich: 'Welche Werte stehen hier im Widerspruch?'",
          speaker: "Praxisanleiterin",
          options: [
            {
              text: "Fürsorge gegen Autonomie. Wir wollen ihr helfen, aber die Fixierung nimmt ihr die Bewegungsfreiheit. Beides sind wichtige Prinzipien.",
              textB1: "Wir wollen ihr helfen. Aber die Fixierung nimmt ihr die Freiheit. Beides ist wichtig.",
              patientResponse: "Genau. Das ist ein klassisches ethisches Dilemma in der Pflege. Es gibt keine einfache Antwort — aber es gibt einen Prozess, um zu einer guten Entscheidung zu kommen.",
              patientResponseB1: "Genau! Das ist ein Dilemma. Es gibt keine einfache Antwort. Aber es gibt einen Weg, gut zu entscheiden.",
              score: 3,
              feedback: "Perfekt! Du benennst den Kernkonflikt: Benefizienz (Fürsorge) vs. Autonomie. Diese vier Prinzipien der Medizinethik (Beauchamp & Childress) sind die Grundlage für ethische Fallbesprechungen.",
              feedbackB1: "Perfekt! Fürsorge gegen Freiheit — das ist der Kern des Problems. Das passiert oft in der Pflege.",
            },
            {
              text: "Es geht um die Sicherheit der Patientin. Die Antibiotika sind wichtig.",
              textB1: "Die Patientin braucht die Medizin. Das ist am wichtigsten.",
              patientResponse: "Ja, die Behandlung ist wichtig. Aber denk weiter — was verliert Frau Weber durch die Fixierung?",
              patientResponseB1: "Ja, die Behandlung ist wichtig. Aber was passiert mit Frau Weber, wenn wir ihre Hände festbinden?",
              score: 2,
              feedback: "Du siehst die medizinische Notwendigkeit — richtig. Aber das ethische Dilemma liegt tiefer: Frau Webers Freiheit und Würde stehen auf dem Spiel. Beide Seiten müssen abgewogen werden.",
              feedbackB1: "Die Medizin ist wichtig. Aber Frau Webers Freiheit auch. Beides muss zusammen bedacht werden.",
            },
            {
              text: "Ich bin mir nicht sicher. Die Ärztin hat das angeordnet, also muss es richtig sein.",
              textB1: "Die Ärztin hat es gesagt. Sie weiß es am besten.",
              patientResponse: "Auch Ärztinnen können sich irren — oder die pflegerische Perspektive übersehen. Deine Stimme als Pflegefachperson zählt.",
              patientResponseB1: "Auch Ärztinnen können sich irren. Deine Meinung als Pflegeperson ist wichtig.",
              score: 1,
              feedback: "Als Pflegefachperson bist du keine reine Ausführende. Du hast eine eigene fachliche und ethische Verantwortung. Bei Bedenken musst du diese äußern — das ist Teil deines Berufsbildes.",
              feedbackB1: "Du darfst und musst deine Meinung sagen! Pflege ist kein Beruf, in dem man nur Anweisungen befolgt.",
            },
          ],
        },
      ],
  ...
  // =============================================================
  {
    ...
    question: {
      ...
      dialogPhases: [
        {
          context: "Yasemin, du hast jetzt die Grundlagen drauf. Was nimmst du aus dieser Lerneinheit mit?",
          contextB1: "Yasemin, was hast du gelernt? Was nimmst du mit?",
          speaker: "Praxisanleiterin",
          options: [
            {
              text: "Pflege ist Wissenschaft UND Menschlichkeit. Bei Frau Weber habe ich gesehen: Ohne Ethik ist Pflege nur Technik. Und ohne Fachwissen ist Empathie hilflos.",
              textB1: "Pflege braucht Wissen UND Herz. Beides zusammen. Das habe ich bei Frau Weber gelernt.",
              patientResponse: "Das klingt reif. Kannst du mir ein konkretes Beispiel geben?",
              patientResponseB1: "Gut! Kannst du ein Beispiel nennen?",
              score: 3,
              feedback: "Hervorragend! Du verbindest Theorie und Praxis und zeigst Reflexionsfähigkeit. Die Verknüpfung von Fachwissen und ethischem Handeln ist der Kern professioneller Pflege.",
              feedbackB1: "Sehr gut! Du hast verstanden, dass Pflege Wissen und Mitgefühl braucht. Beides zusammen macht gute Pflege.",
            },
            {
              text: "Ich habe viel über Kommunikation gelernt. Zuhören ist wichtiger als ich dachte.",
              textB1: "Ich habe gelernt, dass Zuhören sehr wichtig ist.",
              patientResponse: "Ja, Kommunikation ist zentral! Aber was noch? Denk an den Pflegeprozess, die Theorien, die Ethik...",
              patientResponseB1: "Ja, Zuhören ist wichtig! Aber da war noch mehr. Was noch?",
              score: 2,
              feedback: "Kommunikation ist ein wichtiger Aspekt — aber LE 01 umfasst mehr: Pflegeprozess, Pflegetheorien, Ethik, Teamarbeit. Versuche, das große Bild zu sehen.",
              feedbackB1: "Zuhören ist wichtig. Aber du hast auch viel über den Pflegeprozess und Ethik gelernt. Denk an alles zusammen.",
            },
            {
              text: "Ehrlich gesagt bin ich noch unsicher. Es war sehr viel auf einmal.",
              textB1: "Es war sehr viel. Ich bin noch unsicher.",
              patientResponse: "Das ist normal am Anfang! Und weißt du was — dass du das zugibst, zeigt Stärke. Lass uns nochmal zusammenfassen, was du schon kannst.",
              patientResponseB1: "Das ist normal! Es ist gut, dass du ehrlich bist. Wir schauen zusammen, was du schon kannst.",
              score: 1,
              feedback: "Ehrlichkeit ist gut — aber unterschätze dich nicht! Du hast in 8 Sessions den Pflegeprozess, Kommunikation, Ethik und Theorien kennengelernt. Das ist eine solide Basis.",
              feedbackB1: "Sei nicht zu streng mit dir! Du hast sehr viel gelernt. Das ist eine gute Basis für alles, was noch kommt.",
            },
          ],
        },
        {
          context: "Genau. Und das ist der Grund, warum Pflege eine Profession ist — nicht nur ein Beruf. Eine letzte Frage: Was unterscheidet eine Profession von einem Beruf?",
          contextB1: "Pflege ist eine Profession, nicht nur ein Beruf. Was ist der Unterschied?",
          speaker: "Praxisanleiterin",
          options: [
            {
              text: "Eine Profession hat eigenes Fachwissen, ethische Leitlinien und eine wissenschaftliche Basis. Pflege erfüllt das alles — durch den Pflegeprozess, die Berufsethik und die Pflegewissenschaft.",
              textB1: "Eine Profession hat eigenes Wissen, eigene Regeln und Forschung. Pflege hat das alles.",
              patientResponse: "Perfekt zusammengefasst. Du bist bereit für den nächsten Schritt, Yasemin!",
              patientResponseB1: "Genau richtig! Du bist bereit für mehr, Yasemin!",
              score: 3,
              feedback: "Exzellent! Du nennst die drei Merkmale einer Profession: eigenständiges Wissen, Ethikkodex und Wissenschaftsbasis. Das ist Bloom-Stufe 4 — Analyse und Synthese.",
              feedbackB1: "Perfekt! Eigenes Wissen, Ethik und Wissenschaft — das macht Pflege zur Profession.",
            },
            {
              text: "Bei einer Profession hat man mehr Verantwortung als bei einem normalen Beruf.",
              textB1: "Man hat mehr Verantwortung.",
              patientResponse: "Verantwortung ist ein Teil davon, ja. Aber was noch? Denk an das, was Pflege als Wissenschaft ausmacht.",
              patientResponseB1: "Ja, mehr Verantwortung stimmt. Aber was noch?",
              score: 2,
              feedback: "Verantwortung ist ein Aspekt, aber nicht das Alleinstellungsmerkmal. Eine Profession zeichnet sich durch eigenständiges Fachwissen, einen Ethikkodex und wissenschaftliche Fundierung aus.",
              feedbackB1: "Verantwortung stimmt. Aber eine Profession hat auch eigenes Wissen und eigene Forschung. Das ist der große Unterschied.",
            },
            {
              text: "Hmm, ich glaube Professionen verdienen mehr Geld?",
              textB1: "Man verdient mehr Geld?",
              patientResponse: "Das wäre schön! Aber nein — es geht um die fachliche Grundlage und die ethische Verantwortung, nicht ums Gehalt.",
              patientResponseB1: "Nein, es geht nicht ums Geld. Es geht um Wissen und Verantwortung.",
              score: 1,
              feedback: "Gehalt ist kein Merkmal einer Profession. Die Unterscheidung liegt in der wissenschaftlichen Wissensbasis, dem eigenständigen Ethikkodex und der gesellschaftlichen Verantwortung. Pflege erfüllt diese Kriterien.",
              feedbackB1: "Geld ist nicht der Unterschied. Eine Profession hat eigenes Wissen, eigene Regeln und hilft der Gesellschaft.",
            },
          ],
        },
      ],
