...
export const KARTEIKARTEN_AUTO: AutoKarteikarte[] = [
  {
    id: "kk-auto-mobilisation-bobath-konzept",
  ...
  {
    id: "kk-auto-mundpflege-bei-aspirationsrisiko",
  ...
  {
    id: "kk-auto-mobilisation-bettkante-hemiparese",
    bausteinRef: "mobilisation-bettkante-hemiparese",
    themaPrimaer: "mobilisation",
    vorderseite: "Du willst Herrn Petrov (Tag 5 nach Apoplex, Ramipril 5 mg) an die Bettkante bringen. Was misst du wann?",
    rueckseite: "Kreislauf-Vorkontrolle: RR + Puls im Liegen, RR + Puls im Sitzen (sofort nach Aufsetzen), aktiv nach Schwindel/Übelkeit fragen. Bei systolischem Abfall > 20 mmHg: zurücklegen. Ramipril = erhöhtes Orthostase-Risiko. Ziel: 10-15 Min begleitet. Spektrum: Yilmaz (1. POT, Belastungsgrenze), Frau M. (Kinästhetik-Transfer), Schmidt (Bariatrisches Equipment). Faustregel: **Bettkante = Atmung + Kreislauf + Gehirn gleichzeitig. Immer mit Kreislauf-Vorkontrolle.**",
    situationsId: "ls-petrov-schlaganfall",
  },
  {
    id: "kk-auto-harnausscheidung-katheter-indikation",
  ...
  {
    id: "kk-auto-harnausscheidung-bvk-grundlagen",
  ...
  {
    id: "kk-auto-enterale-ernährung-oral-zu-sonde",
    bausteinRef: "enterale-ernährung-oral-zu-sonde",
    themaPrimaer: "enterale-ernährung",
    vorderseite: "Herr Petrov isst seit 2 Tagen nur 40 % seines Kalorienbedarfs oral. Tag 5 nach Apoplex. Was empfiehlst du?",
    rueckseite: "ESPEN/DGEM 2020: 3-5 Tage Zeitfenster für orale Optimierung. Bei < 60 % nach diesem Zeitfenster: NGS (nasogastrale Sonde) als nächste Stufe. Pflege-Aufgabe: proaktiv Arzt informieren, tägliches Ernährungsmonitoring. Spektrum: Nguyen (parenteral post-OP), Schmidt (versteckter Proteinmangel bei Adipositas), Emilia (NGS schon nach 24 h bei Säugling). Faustregel: **3-5 Tage unter 60 % oral = Sonde vorbereiten.**",
    situationsId: "ls-petrov-schlaganfall",
  },
];
