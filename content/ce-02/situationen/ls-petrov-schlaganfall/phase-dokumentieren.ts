  ...
  kernSteps: [
    // Step 6.1 — Freetext LANG: Pflegebericht
    {
      ...
      question: {
        ...
        musterantwort:
          "07:15 Uhr: Herr Petrov (58 J., ischämischer Apoplex Tag 5) in Rückenlage, wach und orientiert (nickt gezielt). Hemiparese rechts unverändert (Arm: kein gezielter Griff; Bein: Anheben möglich). Aphasie: kommuniziert nonverbal (Nicken/Kopfschütteln) und mit Einzelwörtern. 07:55 Uhr: Ganzkörperpflege nach Bobath durchgeführt. Herr Petrov beteiligte die linke Hand aktiv. Haut an Steißbein, Fersen, Schulterblatt: kein Befund. Katheterbeutel hing korrekt, 1.800 ml/24h, Urin goldgelb. 09:05 Uhr: Frühstück angereichert (IDDSI Level 2 + Kostform B, Oberkörper 90°). Beim Trinken: Aspiration-Ereignis — Herr Petrov hustete heftig. Sofortige Maßnahmen: Anreichen gestoppt, auf 90° aufgerichtet, Husten angeregt. Nach 3 Min: Atemgeräusch klar, keine Sättigungsabfall, Herr Petrov wieder ruhig. 09:30 Uhr: Mobilisation — Herr Petrov saß 13 Minuten an der Bettkante, kein Schwindel, linker Daumen hoch nach 8 Min. Natalya (Ehefrau) über Dysphagie informiert, angedickte Flüssigkeit erklärt, Anleitung zum Anreichen gegeben. 10:30 Uhr: Auskultation post-Mobilisation: beidseits ventiliert, kein neu aufgetretenes Rasseln. Offen: Schlucktherapeutin über Aspirationsereignis informieren, Konsistenz Level 3 für Mittagessen prüfen. Katheter Tag 5 — proaktive Arzt-Rücksprache re: vorzeitige Re-Evaluation empfohlen.",
        bewertungskriterien: [
    ...
    // Step 6.3 — Freetext kurz: SBAR-Übergabe mündlich
    {
      ...
      question: {
        ...
        musterantwort:
          "S: Herr Petrov, Zimmer 112, 58 Jahre, Schlaganfall Tag 5, Hemiparese rechts, Dysphagie Grad 2, leichte Broca-Aphasie, BVK seit Tag 1. B: Frühschicht: Körperpflege nach Bobath, Mobilisation 13 Min Bettkante, Frühstück angereichert — Aspirationsereignis beim Trinken, stabilisiert. Natalya über Dysphagie informiert und einbezogen. A: Auskultation stabil, Katheter unauffällig (1.800 ml/24h, goldgelb), kein Dekubituszeichen. R: Schlucktherapeutin über Aspiration informieren, Flüssigkeit Level 3 für Mittagessen — Arzt rückfragen. Katheter Tag 5 — proaktiv Arzt ansprechen re: frühere Entfernung.",
        bewertungskriterien: [
