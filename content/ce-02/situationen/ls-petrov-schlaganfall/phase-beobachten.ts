...
export const CE02_SIT_PETROV_SCHLAGANFALL_BEOBACHTEN: SituationsPhase = {
  ...
  kernSteps: [
    ...
    // braucht er das Bobath-Konzept als Grundhaltung für die gesamte Situation.
    {
      ...
      themenSekundaer: ["kontraktur-prophylaxe", "kinästhetik"],
    ...
    {
      stepId: "ce02-petrov-beob-04b-cauti-prävention",
      phase: 2,
      stepType: "inlineWissen",
      bloomLevel: 2,
      ...
      track: "basis",
      modus: "entdecker",
      lernziel: "ce02-petrov-beob-cauti-prävention",
      tag: "pflege",
    ...
    // Step 2.6 — Hotspot: Hautinspektion (Körpersilhouette)
    {
      ...
      question: {
        ...
        hotspot: {
          imageUrl: "/images/anatomie/körper-rücken-liegend.svg",
          imageAlt:
            "Körpersilhoütte Rückenansicht liegend mit markierbaren Prädilektionsstellen",
          instruction:
    ...
    // Step 2.7 — Matrix: Risikosynthese
    {
      ...
      track: "basis",
      modus: "sortierstation",
      lernziel: "ce02-petrov-beob-risiköinordnung",
      tag: "pflege",
      contentC1: {
        title: "Risiköinordnung",
