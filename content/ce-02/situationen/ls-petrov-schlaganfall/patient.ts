...
export const CE02_SIT_PETROV_SCHLAGANFALL_PATIENT: PatientBeschreibung = {
  ...
  setting:
    "Neurologische Normalstation (Zimmer 112), Frühschicht, 5. Tag nach Ereignis, gestern von Stroke Unit verlegt. Pflegerelevante Risiken: Aspirationsgefahr (Dysphagie), Pneumoniegefahr (reduzierte Atemtiefe + Dysphagie + Immobilität), CAUTI-Risiko (BVK Tag 5), Dekubitusrisiko (Immobilität), Sturzrisiko (geplante Mobilisation, Hemiparese), Kontraktur- und Schultersubluxationsrisiko (hemiparetischer Arm).",
  hintergrund:
    "Viktor Petrov wuchs in Kiew auf, studierte Maschinenbau und kam vor 22 Jahren nach Deutschland. Er spricht fließend Deutsch mit russischem Akzent. In der Fabrik ist er als ruhiger, verlässlicher Teamleiter bekannt. Körperlich war er aktiv: Fußball mit den Kollegen, Fahrradtouren mit der Familie. Vor 5 Tagen wurde er vom Kollegen bewusstlos im Büro aufgefunden — links-hemisphärischer Mediainfarkt. Akuttherapie mit i.v.-Lyse innerhalb des 4,5-h-Zeitfensters (konkret: ca. 3 h post-Symptombeginn). Er ist verheiratet mit Natalya (55), hat zwei erwachsene Kinder. Das Einfamilienhaus hat das Schlafzimmer im Obergeschoss. Die Diagnose trifft ihn mit voller Wucht: Der rechte Arm, mit dem er Zeichnungen erstellt hat, Schrauben festgezogen, seinem Sohn Gitarre gezeigt hat — der Arm funktioniert nicht mehr.",
  hintergrundB1:
  ...
  persoenlichkeit:
    "Ruhig, verlässlich, lösungsorientiert. Macht keine Worte — macht Ergebnisse. Weint selten, und wenn, dann schweigend: wenn Natalya geht, wenn er allein ist, wenn er merkt, dass er nach dem Waschen Hilfe braucht und sich nicht bedanken kann, weil ihm die Worte fehlen. Zentrales Thema: Kontrollverlust bei vollem Bewusstsein. Herr Petrov versteht jeden Satz, jede Erklärung, jedes Gespräch um ihn herum — er sitzt im eigenen Körper wie in einem fremden Fahrzeug, dessen Steürung ausgefallen ist. Er nickt, wenn etwas stimmt. Er zeigt auf sein rechtes Bein, wenn es zieht. Er schüttelt den Kopf, wenn ihm etwas nicht gefällt. Einmal hat er mit der linken Hand den Becher weggeschoben — nicht aus Trotz, aus Unverständnis.",
  zitate: [
    "Morgen... besser?",
    "Nix... da. Nix.",
    "Bitte... langsam.",
