...
export const CE02_SIT_FRAU_M_NACHT_STURZ_BEOBACHTEN: SituationsPhase = {
  ...
  kernSteps: [
    ...
    // (war vorher Step 2 nach PIM, jetzt Step 1 der Phase — erst raten!)
    {
      ...
      quellen: [
        "PRISCUS-Liste 2.0 (Holt et al. 2022)",
    ...
    // Didaktisch besser: erst raten (Brilliant), dann erklären (Inline-Wissen).
    {
      ...
      bloomLevel: 4,
      kompetenzbereich: "I.1",
      quellen: ["PRISCUS 2.0 (Holt et al. 2022)", "Beers-Liste 2023"],
      track: "basis",
      modus: "entdecker",
    ...
    // Step 2.2 — Zolpidem erklärt
    {
      ...
      bloomLevel: 3,
      kompetenzbereich: "I.1",
      quellen: ["PRISCUS 2.0 (Holt et al. 2022)", "DNQP 2022"],
      track: "basis",
      modus: "schreibtisch",
