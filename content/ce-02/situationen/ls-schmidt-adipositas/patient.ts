...
export const CE02_SIT_SCHMIDT_ADIPOSITAS_PATIENT: PatientBeschreibung = {
  ...
  diagnosen: [
    ...
    "Diabetisches Fußsyndrom Kategorie 1 nach Wagner-Armstrong — trockene Haut, erste Rissbildung plantar, keine offene Wunde",
    ...
    "Proteinmangelernährung trotz Übergewicht — Albumin 31 g/l (Norm: 35–52 g/l), NRS 2002 Score 3",
  ],
  ...
  hintergrundB1:
    "Frau Helga Schmidt ist 68 Jahre alt. Sie ist seit 3 Tagen im Krankenhaus auf der Inneren Station. Sie hat Diabetes Typ 2 (= Zucker-Krankheit) seit 8 Jahren. Frau Schmidt hat Übergewicht. Ihr BMI ist 38. Die Nägel darf nur ein Podologe (= Fußpflege-Spezialist) schneiden. Frau Schmidt verliert manchmal unkontrolliert Urin — das nennt man Belastungs-Inkontinenz. Frau Schmidts Albumin-Wert ist niedrig: 31 g/l. Das ist das Paradox: Sie hat Übergewicht, aber ihr Körper hat zu wenig Eiweiß. Frau Schmidt lebt allein. Ihr Sohn wohnt weit weg und kommt selten.",
  persoenlichkeit:
