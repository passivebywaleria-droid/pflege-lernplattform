...
#### F-01 (MITTEL): Musterantwort Pflegebericht widerspricht Hautfalten-Steps [GEFIXT 2026-04-30]
...
- **Fix:** Musterantwort korrigiert: "Trockentupfen, Faltenvlies eingelegt. Hautschutz-Creme duenn auf umgebende intakte Haut ausserhalb der Falte aufgetragen."

---

### Phase 4 — durchfuehren — Step 4.4 (categorize: Protein-Gehalte)

#### F-02 (MITTEL): Fertig-Pizza in falscher Kategorie [GEFIXT 2026-04-30]
...
- **Fix:** Fertigpizza nach Kategorie 1 verschoben (Mittlerer Proteingehalt 5-15 g), Label aktualisiert mit realistischer Portionsgroesse und didaktischem Hinweis auf unguenstiges Protein-Kalorien-Verhaeltnis.

---

### Phase 4 — durchfuehren — Step 4.1b (inlineWissen: Proteine)

#### F-03 (NIEDRIG): Protein-Angabe Fertigpizza inkonsistent mit Step 4.4 [GEFIXT 2026-04-30]
...
- **Fix:** Klarstellung "pro 100 g" mit ganzer Pizza (300 g: ca. 18-24 g) und Kalorienvergleich in C1, B1 und Step 4.2 eingefuegt.

---

### Phase 3 — planen — Step 3.5 (text/scenario: Mobilisationsplan)

#### F-04 (NIEDRIG): Schwerlastbett-Schwelle 250 kg — Quelle? [GEFIXT 2026-04-30]
...
- **Fix:** C1 und B1 korrigiert auf "Schwerlast-/Bariatriebett (Modelle ab ca. 200-450 kg Tragkraft verfuegbar)" mit Verweis auf individuelle Risikobewertung (DGUV 207-018).

---

### Phase 3 — planen — Step 3.6 (branching: Inkontinenz-Versorgung)

#### F-05 (NIEDRIG): Quelle DNQP Ernährungsmanagement falsch zugeordnet [GEFIXT 2026-04-30]
...
- **Fix:** Quelle ersetzt durch "DNQP (2014): Expertenstandard Foerderung der Harnkontinenz in der Pflege".

---

### Phase 2 — beobachten — Step 2.7 (dialog: Inkontinenz)

#### F-06 (NIEDRIG): Score-3-Option dialogPhases[0] — „Harndrang" statt „Harnverlust" [GEFIXT 2026-04-30]
...
- **Fix:** C1 und B1 auf belastungsinkontinenz-spezifische Formulierung umgestellt ("ungewollt Urin verlieren — beim Husten, Niesen oder koerperlicher Anstrengung").

---

### Cross-Step-Konsistenz

#### CS-01 (NIEDRIG): Hautpflege-Sequenz doppelt (Phase 3 + Phase 4) [GEFIXT 2026-04-30]
...
- **Fix:** Phase-4 Step 4.1 body (C1 + B1) ergaenzt mit explizitem Wiederholungs-Verweis auf Phase 3.
