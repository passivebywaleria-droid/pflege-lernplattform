  ...
  kernSteps: [
    ...
    // die Risikofaktoren (Flipcard 1.2) und die Wundinspektion (Phase 2) angeht.
    {
      ...
      contentC1: {
        ...
        body: "",
        glossarBegriffe: ["Dekubitus", "Druckgeschwuer", "NPUAP/EPUAP", "Kategorie I-IV", "Braden-Skala", "Hyperglykaemie", "Mikrozirkulationsstoerung", "Praedilektionsstelle", ],
      },
      contentB1: {
        title: "Was ist ein Dekubitus?",
        body: "",
...
// Step 1.2 — Flipcard (3 Karten): Risikoprofil aktivieren
    ...
    {
      stepId: "ce02-yilmaz-s2-info-03-prioritaet-setzen",
      phase: 1,
      stepType: "mc",
      bloomLevel: 3,
      kompetenzbereich: "I.1",
  ...
  optionaleSteps: [
    ...
    {
      stepId: "ce02-yilmaz-s2-info-opt-01-dokumentation-luecke",
      phase: 1,
      stepType: "text",
      bloomLevel: 2,
      kompetenzbereich: "I.1",
