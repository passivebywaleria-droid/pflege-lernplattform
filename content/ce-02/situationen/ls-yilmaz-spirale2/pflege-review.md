...
#### F-N01 (NIEDRIG): Hotspot-Zones linear statt konzentrisch [GEFIXT 2026-04-30]
...
- **Fix:** x-Werte geaendert: Wundrand x=35, Wundgrund x=50, Mazeration x=65.

### phase-planen — ce02-yilmaz-s2-plan-02-positionierungsplan (sequencing)

#### F-N02 (NIEDRIG): Sortier-Instruction sagt "erst Assessment, dann dokumentieren, dann handeln, dann informieren" [GEFIXT 2026-04-30]
...
- **Fix:** Instruction und body umformuliert auf: "Assessment → Dokumentation → Massnahmenplanung → Patientengespraech" — klarere Planungs-Semantik.

### phase-durchfuehren — body-Text Zaehlfehler

#### F-N03 (NIEDRIG): contentC1.body sagt "7 Schritte", sortItems hat 8 [GEFIXT 2026-04-30]
...
- **Fix:** body auf "8 Schritte" korrigiert.

### phase-evaluieren — ce02-yilmaz-s2-eval-02 (mc multiSelect)

#### F-N04 (NIEDRIG): Option 4 explanation sagt "NUR TEILWEISE RICHTIG", isCorrect=false [GEFIXT 2026-04-30]
...
- **Fix:** Explanation C1 + B1 umformuliert auf "FALSCH in der Grundannahme" mit klarer Begruendung (Pflegepflicht vs. Eigenbewegung).
...
- 4 Findings NIEDRIG (F-N01 bis F-N04 — Stilfragen/Wording) — alle gefixt 2026-04-30
