  ...
  kernSteps: [
    ...
    // Welche Informationen MUESSEN in eine Wunddokumentation?
    {
      ...
      contentC1: {
        ...
        body: "**Wunddokumentation** = systematische schriftliche Beschreibung des Wundzustands nach Schema L-G-F-E-R-A (Lage, Größe, Farbe, Exsudat, Rand, Aktion).\n\nFachbegriff fürs Exsudat:\n\n• **serös** = klare, gelblich-wässrige Wundflüssigkeit; Zeichen einer normalen Heilung. Im Gegensatz dazu: sanguinolent (blutig), purulent (eitrig — Infektionszeichen).",
        glossarBegriffe: ["Wunddokumentation", "Wundgrund", "Exsudat", "Wundrand", "serös", "Flüssigkeit", "Wundflüssigkeit", "purulent"],
      },
      contentB1: {
        title: "Wundbericht — was muss drin stehen?",
        body: "**Wunddokumentation** = die Wunde aufschreiben — Größe, Farbe, was du gemacht hast.\n\n• **serös** = klare, gelbliche Flüssigkeit aus der Wunde — das ist normal und ein gutes Zeichen.",
        glossarBegriffe: ["Wunddokumentation", "serös", "Flüssigkeit", "Wundflüssigkeit", "purulent"],
      },
      inlineWissen: {
  ...
  optionaleSteps: [
    ...
    // Opt 6.6 — Text (stepbystep): Meldepflicht bei Dekubitus (mittlere/starke Schüler)
    {
      ...
      contentB1: {
        ...
        glossarBegriffe: ["CIRS", "SGB XI", "Pflege", "Lernen", "Dokumentation", "Fehler", "Dekubitus"],
      },
    },
  ],
  geschaetzteDauer: 18,
