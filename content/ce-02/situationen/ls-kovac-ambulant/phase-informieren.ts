...
export const CE02_SIT_KOVAC_AMBULANT_INFORMIEREN: SituationsPhase = {
  ...
  kernSteps: [
    // Step 1.1 — Übergabe lesen
    {
      ...
      quellen: ["§ 630f BGB", "Aktionsbündnis Patientensicherheit: SBAR-Übergabe"],
      track: "basis",
      modus: "story",
      ...
      contentC1: {
        ...
        glossarBegriffe: ["Kompressionsstrümpfe", "Obstipation", "Trinkmenge", "SBAR", "COPD", "Herzinsuffizienz", "Übergabe", "Assessment", "Pflegegrad"],
      },
      contentB1: {
        ...
        glossarBegriffe: ["Kompressionsstrümpfe", "Obstipation", "Trinkmenge", "COPD", "Herzinsuffizienz", "Übergabe", "Assessment", "Pflegegrad"],
      },
    },
    ...
    // Step 1.2 — Prioritäten vor der Tür
    {
      ...
      bloomLevel: 2,
      kompetenzbereich: "I.1",
      quellen: ["GOLD-Report COPD 2023", "ESC Heart Failure Guidelines 2023"],
      track: "basis",
      ...
      contentC1: {
        ...
        body: "Du stehst vor der Wohnungstür. Bevor du klingelst, ordnest du die Informationen aus der Übergabe nach klinischer Dringlichkeit.\n\n**Kurz-Definition Prophylaxe:** Prophylaxe = vorbeugende Maßnahme, bevor ein Schaden eintritt. Beispiel: regelmäßige Bewegung gegen Gelenk-Versteifung, Hände-Desinfektion gegen Übertragung von Krankheitskeimen.",
        glossarBegriffe: ["Prophylaxe"],
      },
      contentB1: {
        title: "Was ist am dringendsten?",
        body: "Du stehst vor der Tür von Frau Kovač. Bringe die Informationen aus der Übergabe in eine sinnvolle pflegerische Reihenfolge.\n\n**Kurz erklärt — Prophylaxe:** Prophylaxe = Vorbeugung. Du machst etwas, **bevor** ein Problem entsteht. Beispiel: Hände waschen, **damit** keine Keime auf den Patienten kommen.",
        glossarBegriffe: ["Prophylaxe"],
      },
      question: {
        fragetext:
          "Bringe die Informationen aus der Übergabe in eine pflegerisch sinnvolle Reihenfolge.",
        sortItems: [
          "Kein Stuhlgang seit 4 Tagen",
          "Trinkmenge 820 ml gestern",
          "Erschöpfung nach 3 Min Atemübungen gestern",
          "Kompressionsstrümpfe verweigert",
          "Nur Brot gegessen",
        ],
      },
    },
    ...
    // Step 1.4 — Erstkontakt-Dialog
    {
      ...
      quellen: ["DGSM S3-Leitlinie Insomnie 2017", "DNQP Beziehungsgestaltung bei Demenz 2018"],
      track: "basis",
      modus: "story",
      ...
      contentC1: {
        ...
        body: "Du hast geklingelt, Frau Kovač hat die Tür geöffnet. **Wichtig — du bist Gast in ihrer Wohnung:**\n\n**Hausrecht** = das Recht der Bewohnerin, allein darüber zu bestimmen, wer ihre Wohnung betreten darf. In der ambulanten Pflege bedeutet das: Du bittest um Eintritt ('Guten Morgen, Frau Kovač — darf ich reinkommen?') und betrittst den Wohnraum erst, wenn sie dich hereingebeten hat. Im stationären Setting gilt das anders — dort gehört der Raum dem Krankenhaus, hier gehört er ihr.\n\nFrau Kovač hat dich hereingebeten. Sie wirkt erschöpft, schaltet den Fernseher aus. Du fragst nach der Nacht — Frau Kovač antwortet. Drei Dialogphasen: Begrüßung setzen — Befindlichkeit erheben — Antwort wählen.",
        glossarBegriffe: ["Hausrecht", "Aktives Zuhören"],
      },
      contentB1: {
        title: "Gespräch mit Frau Kovač",
        body: "Du hast geklingelt. Frau Kovač macht die Tür auf. **Wichtig:** Das ist ihre Wohnung.\n\n**Hausrecht** = das Recht der Bewohnerin zu bestimmen, wer reinkommt. Du fragst: 'Guten Morgen, Frau Kovač — darf ich reinkommen?' Erst wenn sie ja sagt, gehst du rein.\n\nFrau Kovač hat dich reingebeten. Sie schaltet den Fernseher aus. Sie wirkt müde. Du führst ein kurzes Gespräch in drei Phasen. Wähle die beste Antwort.\n\n**Aktives Zuhören** = du hörst genau zu, fragst nach, wertest nicht.",
        glossarBegriffe: ["Hausrecht", "Aktives Zuhören"],
      },
      question: {
        ...
        dialogPhases: [
          ...
          {
            context:
              "Du hast die Schlaf-Information erhoben und weißt: Einschlafdauer ca. 30–40 Min, nächtliches Erwachen um 02:00 Uhr, Fernsehen als Kompensation. Jetzt gibst du Frau Kovač eine Vorschau auf den Morgen.",
            contextB1:
    ...
    // Step 1.5 — Comparison: ambulant vs. stationär
    {
      ...
      bloomLevel: 3,
      kompetenzbereich: "I.1",
      quellen: ["§ 630f BGB", "MDS/Medizinischer Dienst 2018"],
      track: "basis",
      modus: "entdecker",
  ...
  optionaleSteps: [
    ...
    // Opt-1.C — Touren-Planung in der ambulanten Pflege (NEU)
    {
      ...
      contentB1: {
        ...
        glossarBegriffe: ["Tour", "Übergabe", "Pflege", "Dokumentation", "Notarzt", "Kontinuität", "Patient"],
      },
    },
  ],
  geschaetzteDauer: 20,
