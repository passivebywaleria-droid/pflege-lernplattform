  ...
  kernSteps: [
    ...
    // Step 6.2 — Matching: Pflegeplan ergänzen
    {
      ...
      contentC1: {
        ...
        body: "Pflegeziele ohne Maßnahmen sind Wünsche. Maßnahmen ohne Ziele sind blinde Aktionen. Das PESR-Prinzip verbindet beides — und sorgt dafür, dass das Team nicht nur weiß WAS zu tun ist, sondern WARUM. Ordne die neün Pflegeziele den passenden Maßnahmen zu.",
      ...
      question: {
        ...
        matchingPairs: [
          ...
          },
          {
            ...
            right: "Analgesie 30 Min vor Mobilisation prüfen, 2-Personen-Unterstützung erste Tage, Teilbelastung rechts max. 20 kg (Mobilisationsstufe 3) beachten, operiertes Bein zürst über Bettkante, Erfolge dokumentieren",
          },
          {
      ...
      question: {
        ...
        summary: {
          ...
          kernaussagen: [
            ...
            "Interkulturelle Pflege: Mustafa als Ressource einbeziehen — aber Sicherheit zürst (Frau Yilmaz erst sicher hinsetzen, dann vermitteln lassen)",
