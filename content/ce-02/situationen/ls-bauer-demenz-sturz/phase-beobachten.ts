...
export const CE02_SIT_BAUER_DEMENZ_STURZ_BEOBACHTEN: SituationsPhase = {
  phaseId: "ls-baür-beobachten",
  phase: "beobachten",
  titel: "Beobachten & Risiken erkennen",
  titelB1: "Schaün und Risiken finden",
  kontext:
    "Herr Baür hat sich etwas beruhigt. Er sitzt noch im Bett, schaut dich manchmal an, manchmal an die Wand. Du hast kurz seine Hand gehalten — das hat geholfen. Jetzt musst du beobachten: Was hat der Sturz hinterlassen? Was zeigt sein Körper dir heute Morgen? Menschen mit Demenz können Schmerzen oft nicht verbalisieren. Sie sagen nicht 'mein Knie tut weh' — sie zeigen es durch Abwehr, durch veränderte Mimik, durch ein Zucken beim Bewegen. Du lernst heute, wie man beobachtet, wenn Worte fehlen.",
  kontextB1:
    "Herr Baür ist etwas ruhiger. Er sitzt im Bett. Du hast seine Hand gehalten — das hat geholfen. Jetzt schaust du: Was hat der Sturz hinterlassen? Was zeigt sein Körper dir heute Morgen? Menschen mit Demenz sagen nicht immer: \"Ich habe Schmerzen.\" Sie zeigen es mit dem Gesicht, mit der Körperhaltung. Du lernst heute: Wie beobachte ich, wenn jemand nicht sprechen kann?",
  kernSteps: [
    // Inline-Wissen: Koerperbeobachtung nach Sturz \u2014 Schonhaltung und Aussenrotation
    {
      stepId: "ce02-baür-beob-00b-körperbeobachtung",
      phase: 2,
      ...
      track: "basis",
      modus: "entdecker",
      lernziel: "ce02-baür-beob-00b-körperbeobachtung",
      tag: "anatomie",
      themaPrimaer: "sturz-prophylaxe",
      themenSekundaer: ["kontraktur-prophylaxe"],
      transition: "Du weisst jetzt worauf du achtest. Schau dir Herrn Baür an \u2014 bevor du irgendetwas misst.",
      contentC1: {
      ...
      inlineWissen: {
        ...
        storyAufhaenger: "Gleich schaust du Herrn Baür an \u2014 noch bevor du irgendetwas misst. Was verraten dir Haltung, Mimik und Beinstellung ueber mögliche Verletzungen? Zwei Begriffe musst du kennen.",
        storyAufhaengerB1: "Du schaust gleich Herrn Baür an. Was verraten Haltung und Beinstellung ueber Verletzungen?",
        kerntext: "Nach einem Sturz ist die **Körperbeobachtung** der erste diagnostische Schritt \u2014 vor jeder Messung (DNQP 2022).\n\n**Schonhaltung** = Der Patient hält eine Körperregion unbewusst ruhig oder in einer bestimmten Position, um Schmerz zu vermeiden. Bei Herrn Baür: Er hält das rechte Bein leicht angewinkelt und bewegt es nicht aktiv.\n\n**Aussenrotation** = Das Bein ist nach aussen gedreht (Fussspitze zeigt nach aussen statt zur Decke). Hinweis auf:\n\u2022 Hüftfraktur (klassisches Zeichen: verkürztes, aussenrotiertes Bein)\n\u2022 Muskuläre Schonung nach Sturz\n\u2022 Kontraktur (bei längerer Immobilität)\n\nBei Herrn Baür: Aussenrotation rechts + Schonhaltung + angespannte Mimik = Schmerzhinweis, auch wenn er es nicht sagen kann.\n\n**Systematik:** Kopf \u2192 Wirbelsäule \u2192 Becken \u2192 Extremitäten. Seitenvergleich (rechts vs. links). Immer BESD beobachten während der Inspektion.",
        kerntextB1: "Nach einem Sturz schaust du zürst den Körper an \u2014 bevor du etwas misst.\n\n**Schonhaltung** = Er hält eine Stelle ruhig, weil es wehtut. Herrn Baürs rechtes Bein ist angewinkelt \u2014 er bewegt es nicht.\n\n**Aussenrotation** = Das Bein ist nach aussen gedreht. Kann auf eine Hüftverletzung hinweisen.\n\nBei Herrn Baür: Bein nach aussen gedreht + er bewegt es nicht + sein Gesicht ist angespannt = Er hat wahrscheinlich Schmerzen.\n\nImmer schaün: Kopf \u2192 Rücken \u2192 Beine. Rechte und linke Seite vergleichen.",
        faustregel: "Schonhaltung + Aussenrotation + angespannte Mimik = Schmerzhinweis. Erst beobachten, dann messen.",
        faustregelB1: "Bein nach aussen gedreht + er bewegt es nicht + Gesicht angespannt = wahrscheinlich Schmerzen. Erst schaün, dann messen.",
        spektrum: [],
        karteikarte: {
          vorderseite: "Herrn Baürs rechtes Bein ist leicht nach aussen gedreht und er bewegt es nicht. Was sagt dir das?",
    ...
    {
      stepId: "ce02-baür-beob-01-brilliant-erstblick",
      phase: 2,
      stepType: "freetext",
      bloomLevel: 3,
      kompetenzbereich: "I.1",
      ...
      track: "basis",
      modus: "schreibtisch",
      lernziel: "ce02-baür-beob-erstblick",
      tag: "pflege",
      bildkategorie: "szene",
      imageAlt:
      ...
      contentC1: {
        ...
        body: "BRILLIANT-FRAGE: Bevor du irgendetwas misst oder untersuchst — schau dir Herrn Baür kurz an. Sein Gesicht, seine Haltung, wie er die Beine hält. Was fällt dir auf?",
        glossarBegriffe: ["Schonhaltung", "Außenrotation"],
      },
      contentB1: {
        title: "Was siehst du — bevor du etwas misst?",
        body: "BEOBACHTUNGS-FRAGE: Schau Herrn Baür an. Schau sein Gesicht an. Schau wie er sitzt. Schau wie er die Beine hält. Beschreibe in 2-3 Sätzen: Was fällt dir auf?",
      ...
      question: {
        ...
        musterantwort:
          "Das rechte Bein ist leicht nach außen gedreht — möglicher Hinweis auf Schonhaltung nach Sturz oder Kontraktur. Herrn Baürs Gesichtsausdruck ist angespannt, die Augenbraün etwas zusammengezogen. Die Decke ist zur Hälfte weggeworfen — er war unruhig.",
        bewertungskriterien: [
    ...
    {
      stepId: "ce02-baür-beob-01b-vitalzeichen-abcde",
      phase: 2,
      stepType: "inlineWissen",
      bloomLevel: 2,
      kompetenzbereich: "I.1",
      ...
      track: "basis",
      modus: "entdecker",
      lernziel: "ce02-baür-beob-01b-vitalzeichen-abcde",
      tag: "pflege",
      themaPrimaer: "sturz-prophylaxe",
      ...
      inlineWissen: {
        ...
        kerntext: "**Vitalzeichen** sind die Basismesswerte des Körpers: Blutdruck (RR), Herzfreqünz (Puls), Atemfreqünz, Saürstoffsättigung (SpO2), Körpertemperatur. Sie zeigen in Sekunden ob der Kreislauf stabil ist.\n\n**ABCDE-Schema** (ERC 2021) ist die Reihenfolge der Ersteinschätzung bei jedem Notfall/Sturz:\n\u2022 **A** = Airway (Atemweg frei?)\n\u2022 **B** = Breathing (Atmung regelmässig?)\n\u2022 **C** = Circulation (Kreislauf: RR, Puls, SpO2)\n\u2022 **D** = Disability (Bewusstsein, Orientierung, Pupillen)\n\u2022 **E** = Exposure (Körper entkleiden, Verletzungen suchen)\n\n**Synkope** = kurzzeitiger Bewusstseinsverlust durch Minderdurchblutung des Gehirns (z. B. Blutdruckabfall beim Aufstehen). Bei Herrn Baür: Mirtazapin kann orthostatische Hypotonie verursachen \u2014 eine Synkope als Sturzursache muss vor Bewegung der Extremitäten ausgeschlossen werden.\n\n**Schmerzsignal** bei Demenz: Kein verbales \"Es tut weh\" \u2014 sondern Grimassieren, Schlagen, Steifwerden, Stöhnlaute. Jedes Abwehrverhalten bei Berührung ist ein potenzielles Schmerzsignal.",
        kerntextB1: "**Vitalzeichen** = die wichtigsten Körperwerte: Blutdruck, Puls, Saürstoff im Blut, Atemfreqünz, Temperatur.\n\n**ABCDE-Schema** = Reihenfolge bei Notfall/Sturz:\n\u2022 A = Atemweg frei?\n\u2022 B = Atmet er normal?\n\u2022 C = Kreislauf (Blutdruck, Puls)\n\u2022 D = Bewusstsein (wach? orientiert?)\n\u2022 E = Körper anschaün (Verletzungen)\n\n**Synkope** = kurze Ohnmacht durch Kreislaufproblem. Herr Baür nimmt Mirtazapin \u2014 das kann den Blutdruck senken. Deshalb: Erst Kreislauf prüfen, dann Beine bewegen.\n\n**Schmerzsignal bei Demenz:** Nicht \"Es tut weh\" \u2014 sondern: Grimasse, Schlagen, steif werden, Stöhnen.",
        faustregel: "ABCDE = zürst Kreislauf, dann Extremitäten. Synkope als Sturzursache ausschließen bevor du bewegst. Schmerzsignal bei Demenz = Verhalten beobachten.",
        faustregelB1: "ABCDE = zürst Kreislauf prüfen. Synkope = kurze Ohnmacht. Schmerz bei Demenz erkennt man am Verhalten.",
        spektrum: [],
        karteikarte: {
          vorderseite: "Warum misst du bei Herrn Baür nach dem Sturz zürst Vitalzeichen \u2014 bevor du sein Knie bewegst?",
          rueckseite: "ABCDE-Schema: Circulation (C) vor Exposure (E). Synkope (Blutdruckabfall als Sturzursache) muss ausgeschlossen werden bevor Extremitäten bewegt werden. Mirtazapin verursacht orthostatische Hypotonie (PRISCUS). Vitalzeichen: RR, Puls, SpO2, Atemfreqünz, Temperatur. Schmerzsignal bei Demenz: Grimasse, Abwehr, Stöhnen \u2014 nicht verbal.",
        },
      },
    },
    ...
    {
      stepId: "ce02-baür-beob-02-sturz-assessment",
      phase: 2,
      stepType: "sequencing",
      bloomLevel: 3,
      kompetenzbereich: "I.1",
      ...
      question: {
        fragetext:
          "Sortiere die Assessment-Schritte in die richtige Reihenfolge (1 = zürst).",
        sequencing: {
    ...
    {
      stepId: "ce02-baür-beob-02b-kontraktur-grundlagen",
      phase: 2,
      stepType: "inlineWissen",
      bloomLevel: 2,
      kompetenzbereich: "I.1",
      ...
      track: "basis",
      modus: "entdecker",
      lernziel: "ce02-baür-beob-kontraktur-grundlagen",
      tag: "pflege",
      themaPrimaer: "kontraktur-prophylaxe",
      themenSekundaer: ["basale-stimulation"],
      transition: "Kontraktur im Kopf? Gut. Jetzt geht es an Herrn Baürs rechtes Knie.",
      contentC1: {
      ...
      inlineWissen: {
        ...
        storyAufhaenger:
          "Herrn Baürs rechtes Knie hat ein Streckdefizit von 20 Grad — das heißt, es lässt sich nicht mehr komplett strecken. 20 Grad klingt nach wenig. Aber wenn daraus 40 werden, kann er nicht mehr stehen. Das nennt man Kontraktur.",
        storyAufhaengerB1:
          "Herrn Baürs rechtes Knie geht nicht mehr ganz gerade. Es fehlen 20 Grad. Wenn es schlimmer wird, kann er nicht mehr stehen. Das heißt Kontraktur.",
        kerntext:
          "Eine **Kontraktur** ist eine daürhafte Versteifung eines Gelenks durch Verkürzung von Muskeln, Sehnen oder Gelenkkapsel (DNQP 2018).\n\n**Warum ist Herr Baür gefährdet?**\n\n• **Immobilität** — er liegt oder sitzt den grössten Teil des Tages. Bewegung findet nur während der Pflege statt.\n\n• **Demenz** — er versteht Aufforderungen zur Bewegung nicht. Aktive Übungen sind kaum möglich.\n\n• **Abwehr bei Pflege** — passive Bewegung wird erschwert wenn er sich gegen Berührung wehrt.\n\n• **Schmerz** — Schonhaltung nach Sturz (rechtes Knie) verstärkt die Immobilität.\n\n**Zeitfaktor:**\n\nKontrakturen entwickeln sich ab **1-2 Wochen Immobilität** (bei aelteren Menschen schneller). Das Streckdefizit von 20 Grad bei Herrn Baür zeigt: der Prozess hat bereits begonnen.\n\n**Beobachtungszeichen:**\n\n• Widerstand beim passiven Bewegen (nicht Schmerz, nicht Abwehr — mechanisch)\n\n• Daürhaft gebeugte Haltung\n\n• Abnehmender Bewegungsumfang (Vergleich rechts/links)",
        kerntextB1:
          "Eine **Kontraktur** ist wenn ein Gelenk daürhaft steif wird (DNQP 2018).\n\n**Warum ist Herr Baür gefährdet?**\n\n• Er bewegt sich fast nicht — er liegt oder sitzt den ganzen Tag.\n\n• Er versteht nicht wenn du sagst: \"Beuge dein Knie.\"\n\n• Er wehrt sich wenn du ihn anfasst.\n\n• Er hat Schmerzen im rechten Knie nach dem Sturz — er bewegt es noch weniger.\n\n**Wie schnell passiert das?**\n\nNach 1-2 Wochen ohne Bewegung kann ein Gelenk schon steifer werden. Herrn Baürs Knie hat schon 20 Grad verloren.\n\n**Was beobachtest du?**\n\n• Widerstand beim Bewegen (nicht weil es wehtut, sondern weil das Gelenk blockiert)\n\n• Das Bein bleibt immer gebeugt\n\n• Weniger Bewegung als gestern",
        faustregel:
        ...
        spektrum: [
          ...
          },
          {
            ...
            kurzbeschreibung:
              "Ambulant: Frau Kovac bewegt sich wegen Atemnot kaum. Sprunggelenk-Kontraktur (Spitzfuss) droht wenn sie daürhaft nur sitzt. Frühe Mobilisation und Physiotherapie sind entscheidend.",
          },
        ],
        sonstBox:
          "Kontrakturarten nach Ursache: **arthrogen** (Gelenkkapsel verklebt), **myogen** (Muskel verkürzt), **tendinogen** (Sehne verkürzt), **neurogen** (Spastik bei ZNS-Schädigung). Bei Herrn Baür wahrscheinlich myogen + arthrogen. Messmethode: **Neutralnull-Methode** — Vergleich mit Gegenseite, Dokumentation in Grad.",
        sonstBoxB1:
          "Kontrakturen können verschiedene Ursachen haben: Gelenk verklebt, Muskel verkürzt, Sehne verkürzt, oder Spastik nach Hirnschädigung. Bei Herrn Baür sind wahrscheinlich Muskel und Gelenk betroffen. Gemessen wird in Grad — Vergleich mit dem anderen Knie.",
        karteikarte: {
          vorderseite:
            "Herrn Baürs rechtes Knie hat ein Streckdefizit von 20 Grad. Warum ist das gefährlich und wie schnell verschlechtert es sich?",
          rueckseite:
            "20 Grad Streckdefizit = beginnende Kontraktur (Gelenk kann nicht mehr voll gestreckt werden). **Ab 1-2 Wochen Immobilität** können erste Kontrakturen entstehen (DNQP 2018). Risikofaktoren Baür: Immobilität, Demenz (versteht Übungen nicht), Abwehr bei Pflege, Schonhaltung nach Sturz. Spektrum: Petrov (Spastik), Yilmaz (post-OP), Kovac (Inaktivität). Faustregel: **Heute nicht bewegt = morgen schwerer zu bewegen.**",
        },
      },
    },
    ...
    {
      stepId: "ce02-baür-beob-03-knie-kontraktur",
      phase: 2,
      stepType: "dialog",
      bloomLevel: 3,
      kompetenzbereich: "I.1",
      ...
      track: "basis",
      modus: "story",
      lernziel: "ce02-baür-beob-gelenkprüfung",
      tag: "pflege",
      contentC1: {
        title: "Gelenkbeweglichkeit prüfen",
        body: "Du möchtest die Gelenkbeweglichkeit von Herrn Baürs Knien prüfen. Er reagiert auf Sprache kaum. Du nährst dich behutsam seinem rechten Knie. Was passiert?",
        glossarBegriffe: ["Kontraktur", "Schmerzsignal", "BESD-Skala"],
      },
      contentB1: {
        title: "Knie prüfen",
        body: "Du willst Herrn Baürs Knie prüfen. Er hört auf Worte kaum. Du gehst langsam zu seinem rechten Knie hin. Was passiert?",
        glossarBegriffe: ["Kontraktur", "Schmerzsignal"],
      },
      question: {
        fragetext:
          "Herr Baür zeigt beim Bewegen seines rechten Knies ein Schmerzsignal. Wie reagierst du?",
        patientName: "Herr Baür",
        dialogPhases: [
          {
            context:
              "Du nimmst behutsam Herrn Baürs rechtes Knie. Beim langsamen Beugen zieht er scharf die Luft ein und sagt:",
            contextB1:
              "Du hältst Herrn Baürs rechtes Knie. Du beugst es langsam. Er zieht die Luft ein und sagt:",
            speaker: "Herr Baür",
            options: [
              {
                text: "Ich halte inne, sage ruhig: 'Ich mache kurz Pause, Herr Baür', und warte. Dann prüfe ich minimal weiter, ohne Schmerzen zu provozieren.",
                textB1:
                  "Ich stoppe. Ich sage ruhig: 'Pause, Herr Baür.' Ich warte. Dann prüfe ich vorsichtig weiter.",
                patientResponse:
                  "Herr Baür entspannt sich leicht nach der Pause. Er schaut zur Seite.",
                patientResponseB1:
                  "Herr Baür wird etwas ruhiger nach der Pause.",
                score: 3,
                feedback:
              ...
              },
              {
                ...
                patientResponse:
                  "Herr Baür schlägt nach deiner Hand.",
                patientResponseB1:
                  "Herr Baür schlägt nach dir.",
                score: 0,
                feedback:
                  "Falsch. Schmerz bei Demenz-Patienten ist ein Stopsignal — nicht zu übergehen. Zwang führt zu Agitation, Vertraünsverlust und kann Verletzungen verschlimmern. Assessment ist wichtig, aber Würde und Schutz haben Vorrang vor Vollständigkeit.",
                feedbackB1:
                  "Falsch. Schmerz ist ein Stopsignal. Nicht übergehen. Er schlägt nach dir — weil er Angst hat. Zuerst stoppen, dann behutsam weiterschaün.",
              },
              {
                ...
                patientResponse:
                  "Herr Baür bleibt sitzen. Er schaut weg.",
                patientResponseB1:
                  "Herr Baür schaut weg.",
                score: 1,
                feedback:
                ...
                feedbackB1:
                  "Manchmal ok — aber hier ist das Assessment nach dem Sturz wichtig. Besser: kurze Pause, dann behutsam weiterschaün. Ganz aufhören ist die letzte Option.",
              },
            ],
          },
        ],
    ...
    {
      stepId: "ce02-baür-beob-03b-exsikkose-hautrisiken",
      phase: 2,
      stepType: "inlineWissen",
      bloomLevel: 2,
      kompetenzbereich: "I.1",
      ...
      track: "basis",
      modus: "entdecker",
      lernziel: "ce02-baür-beob-03b-exsikkose-hautrisiken",
      tag: "pflege",
      themaPrimaer: "sturz-prophylaxe",
      ...
      inlineWissen: {
        ...
        spektrum: [],
        karteikarte: {
          vorderseite: "Herrn Baürs Trinkmenge beträgt 900 ml/Tag, seine Inkontinenzversorgung ist 3x nass, und er stürzt nachts. Wie hängen diese drei Risiken zusammen?",
    ...
    {
      stepId: "ce02-baür-beob-04-haut-trinkprotokoll",
      phase: 2,
      stepType: "highlight",
      bloomLevel: 4,
      kompetenzbereich: "I.1",
      ...
      track: "basis",
      modus: "entdecker",
      lernziel: "ce02-baür-beob-risikofaktoren-pflege",
      tag: "krankheitslehre",
      contentC1: {
      ...
      question: {
        ...
        highlightSegments: [
          ...
          },
          {
            ...
            isError: true,
            reason:
              "Hinweis auf hohe nächtliche Inkontinenz-Freqünz / nächtliche Polyurie. Der Wechsel selbst ist Schutzmaßnahme — das Risiko liegt in der Feuchtigkeitsbelastung der Haut zwischen den Wechseln (IAD-Risiko, DNQP Förderung Harnkontinenz / Hinweispapier IAD). Zusätzlich = nächtliche Toilettengang-Auslöser → Sturzrisiko-Faktor (passt zum Sturzereignis 02:30 Uhr).",
            reasonB1:
    ...
    {
      stepId: "ce02-baür-beob-04b-schmerz-besd-wiederbegegnung",
      phase: 2,
      stepType: "inlineWissen",
      bloomLevel: 2,
      kompetenzbereich: "I.1",
      ...
      track: "basis",
      modus: "entdecker",
      lernziel: "ce02-baür-beob-besd-wiederbegegnung",
      tag: "pflege",
      themaPrimaer: "sturz-prophylaxe",
      themenSekundaer: ["basale-stimulation", "ganzkörperpflege"],
      transition: "Schmerzerfassung läuft bei Herrn Baür ueber Beobachtung, nicht ueber Fragen. Jetzt: Risiken sortieren.",
      contentC1: {
    ...
    {
      stepId: "ce02-baür-beob-05-risiken-einordnen",
      phase: 2,
      stepType: "categorize",
      bloomLevel: 4,
      kompetenzbereich: "I.1",
      ...
      track: "basis",
      modus: "sortierstation",
      lernziel: "ce02-baür-beob-risikokategorien",
      tag: "pflege",
      contentC1: {
        title: "Risikofaktoren kategorisieren",
        body: "Kategorisiere die Risikofaktoren von Herrn Baür in drei Gruppen: Sturzrisiko, Kontrakturrisiko, Hautrisiko. Manche Faktoren gelten für mehrere Kategorien — ordne sie der wichtigsten zu.",
        glossarBegriffe: [
          "Sturzrisiko",
          "Kontrakturrisiko",
          "Exsikkose",
  ...
  optionaleSteps: [
    ...
    {
      stepId: "ce02-baür-beob-06-besd-skala",
      phase: 2,
      stepType: "text",
      bloomLevel: 3,
      kompetenzbereich: "I.1",
    ...
    {
      stepId: "ce02-baür-beob-07-kontraktur-neutral-null",
      phase: 2,
      stepType: "comparison",
      bloomLevel: 3,
      kompetenzbereich: "I.1",
      ...
      track: "vertiefung",
      modus: "entdecker",
      lernziel: "ce02-baür-beob-kontraktur-stellung",
      tag: "anatomie",
      contentC1: {
        title: "Funktionsstellung vs. Kontrakturstellung",
        body: "Was droht Herrn Baür wenn die Kniegelenke nicht bewegt werden? Vergleiche Funktionsstellung und Kontrakturstellung.",
        glossarBegriffe: ["Kontraktur", "Funktionsstellung", "Neutralnull-Methode"],
      },
      contentB1: {
        title: "Was passiert ohne Bewegung?",
        body: "Was passiert mit Herrn Baürs Knien, wenn niemand sie bewegt? Vergleiche die zwei Stellungen.",
          ...
          rows: [
            {
              ...
              values: [
                ...
                "Beugestellung ≥ 20° daürhaft — kann nicht mehr gestreckt werden",
              ],
              valuesB1: [
            ...
            },
            {
              ...
              values: [
                "Regelmäßige passive Bewegung verhindert Kontraktur daürhaft",
