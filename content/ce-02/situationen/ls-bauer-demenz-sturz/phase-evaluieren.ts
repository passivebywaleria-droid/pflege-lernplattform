...
export const CE02_SIT_BAUER_DEMENZ_STURZ_EVALUIEREN: SituationsPhase = {
  ...
  kernSteps: [
    ...
    {
      stepId: "ce02-bauer-eval-01-ziele-prüfung",
      phase: 5,
      stepType: "categorize",
      bloomLevel: 4,
      kompetenzbereich: "I.1",
    ...
    // "kein Sturz heute" und "wirksamer Sturzschutz"?
    {
      ...
      inlineWissen: {
        ...
        wiederbegegnung: {
          ...
          basisPatient: "Frau M.",
          vertiefung:
            "Sturzrisikofaktoren und Maßnahmen kennst du — jetzt die Evaluations-Frage: Herr Bauer ist heute nicht gestürzt. Heißt das, die Maßnahmen wirken? Nicht unbedingt. Der DNQP 2022 (Kriterium E5) unterscheidet: **Ergebnis-Evaluation** (kein Sturz) und **Prozess-Evaluation** (wurden alle Maßnahmen umgesetzt?). Beides zusammen ergibt das Bild.",
          vertiefungB1:
            "Du kennst die Sturzrisiken von Phase 1 und die Maßnahmen von Phase 3. Herr Bauer ist heute nicht gestürzt. Heißt das, alles hat funktioniert? Nicht unbedingt. Du musst prüfen: Wurden alle Maßnahmen gemacht? Und: Hat er nicht gestürzt WEIL sie gemacht wurden?",
        },
        storyAufhaenger:
          "Es ist 15:30 Uhr. Herr Bauer ist heute nicht gestürzt. Trinkmenge bei 1000 ml (Ziel 1500). Nachtlicht und Niedrigbett stehen noch nicht. War der Tag ein Erfolg?",
        storyAufhaengerB1:
          "Es ist 15:30 Uhr. Herr Bauer ist nicht gestürzt. Aber er hat nur 1000 ml getrunken und Nachtlicht fehlt noch. War das ein guter Tag?",
        kerntext:
          "Der DNQP 2022 (Kriterium E5) fordert bei Sturzprophylaxe eine **systematische Evaluation** — nicht nur \"ist er gestürzt oder nicht\".\n\n**Zwei Evaluations-Ebenen:**\n\n• **Ergebnis-Evaluation:** Hat sich das Sturzrisiko verändert? Bei Herr Bauer: kein erneuter Sturz heute — aber das Risikoprofil ist unverändert (Demenz + Mirtazapin + Inkontinenz + Desorientierung). Einzelergebnis ≠ Risikoreduktion.\n\n• **Prozess-Evaluation:** Wurden alle geplanten Maßnahmen umgesetzt?\n  - Niedrigbett eingerichtet? → **Nein** (noch nicht umgesetzt)\n  - Nachtlicht installiert? → **Nein** (Übergabe an Nachtdienst)\n  - Toilettengang vor Schlafengehen? → **Noch nicht geprüft**\n  - Mirtazapin-Dosis beim Arzt gemeldet? → **Ja**\n  - Sensormatte bestellt? → **Nein** (offen)\n\n**Evaluation-Intervalle bei hohem Sturzrisiko:**\n\n• Taeglich in den ersten 72h nach Sturzereignis\n• Dann wöchentlich\n• Bei jedem Sturzfolge-Ereignis sofort neu\n\n**Sturz trotz Maßnahmen?** Kein Versagen — aber Anlass für Re-Assessment und Plan-Anpassung.",
        kerntextB1:
        ...
        karteikarte: {
          vorderseite:
            "Herr Bauer ist heute nicht gestürzt. Nachtlicht und Niedrigbett stehen noch nicht. Ist die Sturzprophylaxe erfolgreich?",
          rueckseite:
            "**Nein** — Ergebnis (kein Sturz) ≠ Prozess (Maßnahmen umgesetzt). DNQP 2022, E5 fordert **beide** Evaluationsebenen. Bei Herrn Bauer: Nachtlicht, Niedrigbett, Sensormatte NICHT umgesetzt → Prozess-Evaluation NICHT bestanden. Evaluations-Intervalle: täglich in 72h nach Sturz, dann wöchentlich. Spektrum: Frau M. (situativ, sinkt mit Genesung), Yilmaz (Mobilisationsfortschritt), Schmidt (chronisch, monatlich). Faustregel: **Kein Sturz + alle Maßnahmen umgesetzt = Erfolg. Kein Sturz allein = Zufall.**",
        },
      },
    },
// Step 5.2 — Dialog: Angehörigen-Gespräch mit Ingrid
    {
      stepId: "ce02-bauer-eval-02-angehörigen-gespräch",
      phase: 5,
      stepType: "dialog",
      bloomLevel: 5,
      ...
      track: "basis",
      modus: "story",
      lernziel: "ce02-bauer-eval-angehörigenkommunikation",
      tag: "pflege",
      contentC1: {
    ...
    // Step 5.3 — Text: Schuldgefühle von Angehörigen
    {
      ...
      track: "basis",
      modus: "entdecker",
      lernziel: "ce02-bauer-eval-angehörige-verständnis",
      tag: "pflege",
  ...
  optionaleSteps: [
    ...
    {
      stepId: "ce02-bauer-eval-05b-flüssigkeitsbilanz",
      phase: 5,
      stepType: "inlineWissen",
      bloomLevel: 2,
      kompetenzbereich: "I.1",
      ...
      track: "basis",
      modus: "entdecker",
      lernziel: "ce02-bauer-eval-05b-flüssigkeitsbilanz",
      tag: "krankheitslehre",
      themaPrimaer: "pflegeprozess",
    ...
    // Step 5.6 — Calculation: Flüssigkeitsbilanz
    {
      ...
      track: "vertiefung",
      modus: "challenge",
      lernziel: "ce02-bauer-eval-flüssigkeitsbilanz",
      tag: "krankheitslehre",
      contentC1: {
