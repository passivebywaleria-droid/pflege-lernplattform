...
export const CE02_SIT_BAUER_DEMENZ_STURZ_EVALUIEREN: SituationsPhase = {
  ...
  kernSteps: [
    // Inline-Wissen: Evaluation \u2014 hat der Plan funktioniert?
    {
      ...
      track: "basis",
      modus: "entdecker",
      lernziel: "ce02-baür-eval-00b-evaluation-grundlagen",
      tag: "pflege",
      ...
      contentB1: {
        title: "Überprüfen: Hat der Plan funktioniert?",
        body: "",
        glossarBegriffe: ["Evaluation", "Pflegeziel", "Anpassung"],
      },
      inlineWissen: {
        bausteinRef: "pflegeprozess-evaluation",
        storyAufhaenger: "Es ist Nachmittag. Der Tag mit Herrn Baür neigt sich dem Ende. Jetzt kommt Schritt 5 im Pflegeprozess: **Evaluation** \u2014 die systematische Überprüfung ob die geplanten Pflegeziele erreicht wurden.",
        storyAufhaengerB1: "Es ist Nachmittag. Jetzt prüfst du: Hat der Plan von heute Morgen funktioniert?",
        kerntext: "**Evaluation** (Fiechter/Meier 1981) = 5. Schritt im Pflegeprozess. Systematischer Vergleich: Pflegeziel vs. tatsächliches Ergebnis.\n\n**3 mögliche Ergebnisse:**\n\u2022 **Ziel erreicht** \u2014 Maßnahme beibehalten oder abschließen.\n\u2022 **Ziel teilweise erreicht** \u2014 Maßnahme intensivieren oder anpassen.\n\u2022 **Ziel nicht erreicht** \u2014 Plan ueberarbeiten (**Anpassung**). Neue Ursachenanalyse.\n\nBei Herrn Baür heute: Manche Ziele erreicht (Körperpflege, Kniebewegung), manche offen (Trinkmenge, Nachtlicht). Die **Anpassung** ist kein Scheitern \u2014 sie ist Teil des Pflegeprozesses.\n\nEvaluation ist NICHT \"Hat es heute geklappt?\" \u2014 sondern: \"Wurde das Ziel erreicht, und wenn nicht, warum nicht, und was ändern wir?\"",
        kerntextB1: "**Evaluation** = prüfe ob der Plan funktioniert hat.\n\n**3 Ergebnisse:**\n\u2022 Ziel erreicht \u2014 weiter so.\n\u2022 Ziel teilweise erreicht \u2014 anpassen.\n\u2022 Ziel nicht erreicht \u2014 Plan ändern (**Anpassung**).\n\nBei Herrn Baür: Manche Ziele erreicht (Pflege, Knie), manche offen (Trinken, Nachtlicht). Das ist normal. **Anpassung** gehört zum Pflegeprozess.",
        faustregel: "Evaluation = Ziel vs. Ergebnis vergleichen. Anpassung ist kein Scheitern \u2014 sie ist Teil des Prozesses.",
        faustregelB1: "Evaluation = prüfe ob es geklappt hat. Wenn nicht: Plan ändern. Das ist normal.",
        spektrum: [],
        karteikarte: {
          vorderseite: "Was bedeutet Evaluation im Pflegeprozess und welche drei Ergebnisse sind möglich?",
    ...
    {
      stepId: "ce02-baür-eval-01-ziele-prüfung",
      phase: 5,
      stepType: "categorize",
      bloomLevel: 4,
      kompetenzbereich: "I.1",
      ...
      lernziel: "ce02-baür-eval-pflegeziele",
      tag: "pflege",
      contentC1: {
    ...
    {
      stepId: "ce02-baür-eval-01b-sturzschutz-evaluation",
      phase: 5,
      stepType: "inlineWissen",
      bloomLevel: 3,
      kompetenzbereich: "I.1",
      ...
      track: "basis",
      modus: "entdecker",
      lernziel: "ce02-baür-eval-sturzschutz-evaluation",
      tag: "pflege",
      themaPrimaer: "sturz-prophylaxe",
      themenSekundaer: ["kontraktur-prophylaxe"],
      transition: "Sturzschutz evaluiert. Jetzt wartet Ingrid — das schwierigste Gespräch des Tages.",
      contentC1: {
        title: "Sturzschutz evaluieren — wann ist eine Maßnahme wirksam?",
        body: "",
        glossarBegriffe: ["Evaluation", "Sturzprophylaxe", "DNQP Kriterium E5", "Angehörigenkommunikation", "Betreuung", "Ehrlichkeit", "Empathie", "Gesetzliche Betreuung", "Schuldgefühle", "Schweigepflicht", "Transparenz", ],
      },
      contentB1: {
      ...
      inlineWissen: {
        ...
        wiederbegegnung: {
          ...
          basisPatient: "Frau M.",
          vertiefung:
            "Sturzrisikofaktoren und Maßnahmen kennst du — jetzt die Evaluations-Frage: Herr Baür ist heute nicht gestürzt. Heißt das, die Maßnahmen wirken? Nicht unbedingt. Der DNQP 2022 (Kriterium E5) unterscheidet: **Ergebnis-Evaluation** (kein Sturz) und **Prozess-Evaluation** (wurden alle Maßnahmen umgesetzt?). Beides zusammen ergibt das Bild.",
          vertiefungB1:
            "Du kennst die Sturzrisiken von Phase 1 und die Maßnahmen von Phase 3. Herr Baür ist heute nicht gestürzt. Heißt das, alles hat funktioniert? Nicht unbedingt. Du musst prüfen: Wurden alle Maßnahmen gemacht? Und: Hat er nicht gestürzt WEIL sie gemacht wurden?",
        },
        storyAufhaenger:
          "Es ist 15:30 Uhr. Herr Baür ist heute nicht gestürzt. Trinkmenge bei 1000 ml (Ziel 1500). Nachtlicht und Niedrigbett stehen noch nicht. War der Tag ein Erfolg?",
        storyAufhaengerB1:
          "Es ist 15:30 Uhr. Herr Baür ist nicht gestürzt. Aber er hat nur 1000 ml getrunken und Nachtlicht fehlt noch. War das ein guter Tag?",
        kerntext:
          "Der DNQP 2022 (Kriterium E5) fordert bei Sturzprophylaxe eine **systematische Evaluation** — nicht nur \"ist er gestürzt oder nicht\".\n\n**Zwei Evaluations-Ebenen:**\n\n• **Ergebnis-Evaluation:** Hat sich das Sturzrisiko verändert? Bei Herr Baür: kein erneuter Sturz heute — aber das Risikoprofil ist unverändert (Demenz + Mirtazapin + Inkontinenz + Desorientierung). Einzelergebnis ≠ Risikoreduktion.\n\n• **Prozess-Evaluation:** Wurden alle geplanten Maßnahmen umgesetzt?\n  - Niedrigbett eingerichtet? → **Nein** (noch nicht umgesetzt)\n  - Nachtlicht installiert? → **Nein** (Übergabe an Nachtdienst)\n  - Toilettengang vor Schlafengehen? → **Noch nicht geprüft**\n  - Mirtazapin-Dosis beim Arzt gemeldet? → **Ja**\n  - Sensormatte bestellt? → **Nein** (offen)\n\n**Evaluation-Intervalle bei hohem Sturzrisiko:**\n\n• Taeglich in den ersten 72h nach Sturzereignis\n• Dann wöchentlich\n• Bei jedem Sturzfolge-Ereignis sofort neu\n\n**Sturz trotz Maßnahmen?** Kein Versagen — aber Anlass für Re-Assessment und Plan-Anpassung.",
        kerntextB1:
          "Evaluation heißt: **Prüfe ob dein Plan funktioniert hat.**\n\n**Zwei Fragen:**\n\n• **Ist er gestürzt?** Heute nicht — gut. Aber sein Risiko ist noch genau so hoch wie gestern.\n\n• **Wurden alle Maßnahmen gemacht?**\n  - Niedrigbett? → Nein\n  - Nachtlicht? → Nein\n  - Toilette vor dem Schlafen? → Noch nicht geprüft\n  - Arzt wegen Mirtazapin? → Ja\n\n**Wann evaluieren?**\n\n• Erste 3 Tage nach Sturz: täglich\n• Dann: jede Woche\n• Bei neüm Sturz: sofort",
        faustregel:
        ...
        spektrum: [
          {
            ...
            kurzbeschreibung:
              "Bei Frau M. zeigt die Evaluation nach 72h: Schellong-Protokoll, NRS-Verlauf, Betthöhe angepasst, Rufknopf in Reichweite. Ihr Sturz war situativ (Pneumonie + Nacht) — Risiko sinkt mit Genesung.",
          },
          {
            ...
            kurzbeschreibung:
              "Nach Hüft-TEP: Evaluation fokussiert auf Mobilisationsfortschritt (Tag 1: Bettrand, Tag 2: Stehen, Tag 3: erste Schritte). Sturzschutz = engmaschige Physiotherapie + Gehwagen.",
          },
          {
            ...
            kurzbeschreibung:
              "Bei chronischem Sturzrisiko (Polyneuropathie): Evaluation nicht täglich sondern monatlich. Ziel: Stabilität erhalten, nicht Risiko eliminieren. Schuhwerk-Check, Fußinspektion, Gleichgewichtsübungen.",
          },
        ],
        karteikarte: {
          vorderseite:
            "Herr Baür ist heute nicht gestürzt. Nachtlicht und Niedrigbett stehen noch nicht. Ist die Sturzprophylaxe erfolgreich?",
          rueckseite:
            "**Nein** — Ergebnis (kein Sturz) ≠ Prozess (Maßnahmen umgesetzt). DNQP 2022, E5 fordert **beide** Evaluationsebenen. Bei Herrn Baür: Nachtlicht, Niedrigbett, Sensormatte NICHT umgesetzt → Prozess-Evaluation NICHT bestanden. Evaluations-Intervalle: täglich in 72h nach Sturz, dann wöchentlich. Spektrum: Frau M. (situativ, sinkt mit Genesung), Yilmaz (Mobilisationsfortschritt), Schmidt (chronisch, monatlich). Faustregel: **Kein Sturz + alle Maßnahmen umgesetzt = Erfolg. Kein Sturz allein = Zufall.**",
        },
      },
    },
// Step 5.2 — Dialog: Angehörigen-Gespräch mit Ingrid
    {
      stepId: "ce02-baür-eval-02-angehörigen-gespräch",
      phase: 5,
      stepType: "dialog",
      bloomLevel: 5,
      ...
      track: "basis",
      modus: "story",
      lernziel: "ce02-baür-eval-angehörigenkommunikation",
      tag: "pflege",
      contentC1: {
        title: "Gespräch mit Tochter Ingrid",
        body: "Vorbedingung geklärt: Bevor du Auskunft gibst, prüfst du in der Akte: Ingrid Baür ist als gesetzliche Betreürin (Bestellung 2024, Aufgabenkreis Gesundheitssorge) eingetragen — Auskunft ist also rechtlich zulässig (§ 203 StGB Schweigepflicht ↔ Betreuung nach § 1814 BGB; DSGVO Art. 9). Wäre sie nicht Betreürin, müsstest du an Stationsleitung verweisen.\n\nIngrid Baür (55, Grundschullehrerin) steht vor dir. Aufgewühlt, Schuldgefühle im Gesicht. Ihr erster Satz: 'Hätte das nicht verhindert werden können? Warum war er allein im Flur?' — Du führst das Gespräch.",
        glossarBegriffe: [
          "Empathie",
      ...
      contentB1: {
        ...
        body: "Wichtig vorher: Du schaust kurz in die Akte: Ist Ingrid die gesetzliche Betreürin? Bei Herrn Baür: ja (seit 2024). Das heißt: Du darfst ihr Auskunft geben. Wenn nicht: an die Stationsleitung verweisen.\n\nIngrid Baür kommt zur Station. Sie ist aufgeregt und macht sich Vorwürfe. Sie fragt: 'Hätte das nicht verhindert werden können? Warum war er allein im Flur?' — Was sagst du?",
      ...
      question: {
        ...
        patientName: "Ingrid Baür (Tochter)",
        dialogPhases: [
          {
            context:
              "Ingrid Baür schaut dich an, Augen feucht. Sie sagt: 'Hätte das nicht verhindert werden können? Warum war er allein im Flur?'",
            contextB1:
              "Ingrid schaut dich an. Ihre Augen sind feucht. Sie sagt: 'Hätte das nicht verhindert werden können?'",
            speaker: "Ingrid",
            options: [
              {
                text: "\"Frau Baür, ich kann verstehen, wie aufgewühlt Sie gerade sind. Ich bin froh, dass Sie hier sind — ich möchte Ihnen erklären, was in der Nacht passiert ist.\"",
                textB1:
                  "\"Frau Baür, ich verstehe, dass Sie aufgewühlt sind. Ich erkläre Ihnen was passiert ist.\"",
                patientResponse:
                ...
                score: 3,
                feedback:
                  "Richtig. Empathie zürst — keine Rechtfertigung, kein Ablenkungsmanöver. Du nimmst ihr Gefühl ernst und kündigst an, dass du erklärst. Das ist der wichtigste erste Schritt.",
                feedbackB1:
              ...
              },
              {
                ...
                score: 0,
                feedback:
                  "Defensiv und wenig glaubwürdig. Ingrid weiß, dass Stürze bei Demenz häufig vorkommen — das ist kein Ausnahmefall. Defensive Reaktionen verringern Vertraün. Ehrlichkeit und Empathie sind wirksamer.",
                feedbackB1:
              ...
              },
              {
                ...
                feedbackB1:
                  "Nicht falsch — aber Ingrid braucht zürst das Gefühl, dass du sie verstehst. Dann erst die sachliche Erklärung.",
              },
            ],
          },
          {
          ...
          {
            context:
              "Plötzlich kommt Herr Baür in einem Rollstuhl in die Flurnähe — eine Pflegerin hat ihn zum Nachmittagsspaziergang gefahren. Er sieht Ingrid und sagt:",
            contextB1:
              "Plötzlich kommt Herrn Baür im Rollstuhl auf den Flur. Er sieht Ingrid und sagt:",
            speaker: "Herr Baür",
            options: [
              {
                ...
                patientResponse:
                  "Herr Baür streckt die Hand aus und sagt: \"Mein Kind...\" Ingrid tritt auf ihn zu, nimmt seine Hand. Ihre Augen füllen sich mit Tränen.",
                patientResponseB1:
                  "Herr Baür sagt: \"Mein Kind...\" Ingrid geht zu ihm hin. Sie nimmt seine Hand.",
                score: 3,
                feedback:
              ...
              {
                text: "Du sagst: \"Herr Baür, das ist Ihre Tochter Ingrid — erkennen Sie sie?\"",
                textB1:
                  "Du sagst: \"Das ist Ihre Tochter Ingrid — kennen Sie sie?\"",
                patientResponse:
                  "Herr Baür schaut dich an, dann Ingrid — der Moment ist gebrochen.",
                patientResponseB1:
                  "Herr Baür schaut dich an. Der Moment ist vorbei.",
                score: 0,
                feedback:
                  "Du unterbrichst einen lichten Moment. Herr Baür erkennt Ingrid — das ist ein kostbares Ereignis. Solche Momente brauchen keine pflegerische Moderation.",
                feedbackB1:
                  "Du unterbrichst. Herrn Baür erkennt gerade seine Tochter — das ist selten und wertvoll. Solche Momente brauchen Stille.",
              },
            ],
          },
          {
            context:
              "Nach dem Moment zwischen Herr Baür und Ingrid: Wie schließt du das Gespräch ab?",
            contextB1:
              "Wie beendest du das Gespräch mit Ingrid?",
            speaker: "Du",
            options: [
              {
                text: "\"Frau Baür, ich freue mich, dass Sie heute da sind. Ihr Vater erkennt Sie — das ist etwas Besonderes. Wenn Sie morgen anrufen möchten um zu hören wie die Nacht war, rufen Sie gerne an. Und wenn Sie Fragen haben — ich bin ansprechbar.\"",
                textB1:
                  "\"Frau Baür, schön dass Sie da waren. Ihr Vater hat Sie erkannt — das ist schön. Wenn Sie morgen anrufen wollen, rufen Sie an. Fragen Sie mich — ich helfe Ihnen.\"",
                patientResponse:
    ...
    {
      stepId: "ce02-baür-eval-03-schuld-entlastung",
      phase: 5,
      stepType: "text",
      bloomLevel: 4,
      kompetenzbereich: "V.1",
    ...
    {
      stepId: "ce02-baür-eval-03b-reflexion-begriffe",
      phase: 5,
      stepType: "inlineWissen",
      bloomLevel: 2,
      kompetenzbereich: "I.1",
      quellen: ["Schön D.A. (1983): The Reflective Practitioner"],
      track: "basis",
      modus: "entdecker",
      lernziel: "ce02-baür-eval-03b-reflexion-begriffe",
      tag: "pflege",
      themaPrimaer: "pflegeprozess",
      themenSekundaer: [],
      ...
      inlineWissen: {
        ...
        storyAufhaenger: "Der Tag mit Herrn Baür war lang. Reflexion ist nicht Tagebuch \u2014 sondern professionelles Werkzeug.",
        storyAufhaengerB1: "Reflexion: Was habe ich gelernt? Was mache ich nächstes Mal anders?",
        kerntext: "**Reflexion** = systematisches Nachdenken ueber eigenes Handeln (Schön 1983). Nicht Gefühle sondern: Was habe ich beobachtet? Was getan? Was ändern?\n\n**Professionalisierung** = Weg vom Anfänger zum Experten. Reflexion ist der Motor: Jede reflektierte Erfahrung macht besser.\n\n**Lernen** in der Pflege: Fachwissen + Handlungskompetenz + Haltungskompetenz. Heute alle drei berührt.",
        kerntextB1: "**Reflexion** = nachdenken ueber dein Handeln. Was gesehen? Was getan? Was ändern?\n\n**Professionalisierung** = vom Anfänger zum Experten. Reflexion hilft.\n\n**Lernen** = Wissen + Koennen + Haltung.",
        ...
        karteikarte: {
          ...
          rueckseite: "Reflexion (Schön 1983): Beobachtung \u2192 Handlung \u2192 Bewertung \u2192 Verbesserung. Professionalisierung durch reflektierte Erfahrung.",
        },
      },
    },
    ...
    {
      stepId: "ce02-baür-eval-04-reflexion-tag",
      phase: 5,
      stepType: "reflection",
      bloomLevel: 5,
      ...
      track: "basis",
      modus: "schreibtisch",
      lernziel: "ce02-baür-eval-reflexion",
      tag: "pflege",
      contentC1: {
        title: "Reflexion: Was hat dich heute überrascht?",
        body: "Nach einem langen Tag mit Herrn Baür und Ingrid: Was hat dich am meisten überrascht — beim Umgang mit Herrn Baür ODER beim Gespräch mit seiner Tochter? Was würdest du beim nächsten Mal anders machen?",
        glossarBegriffe: ["Reflexion", "Professionalisierung"],
      },
      contentB1: {
        title: "Was hast du heute gelernt?",
        body: "Was hat dich heute überrascht — bei Herrn Baür ODER beim Gespräch mit Ingrid? Was machst du beim nächsten Mal anders?",
        glossarBegriffe: ["Reflexion", "Lernen"],
      },
      question: {
        fragetext:
  ...
  optionaleSteps: [
    ...
    {
      stepId: "ce02-baür-eval-05-vips-modell",
      phase: 5,
      stepType: "text",
      bloomLevel: 4,
      kompetenzbereich: "II.1",
    ...
    {
      stepId: "ce02-baür-eval-05b-flüssigkeitsbilanz",
      phase: 5,
      stepType: "inlineWissen",
      bloomLevel: 2,
      kompetenzbereich: "I.1",
      ...
      track: "basis",
      modus: "entdecker",
      lernziel: "ce02-baür-eval-05b-flüssigkeitsbilanz",
      tag: "krankheitslehre",
      themaPrimaer: "pflegeprozess",
      themenSekundaer: ["ganzkörperpflege"],
      transition: "Begriffe klar? Berechne jetzt die Bilanz.",
      contentC1: {
        title: "Flüssigkeitsbilanz \u2014 Einfuhr, Ausfuhr, Perspiratio",
        body: "",
        glossarBegriffe: ["Perspiratio", "Einfuhr", "Ausfuhr"],
      },
      contentB1: {
        title: "Flüssigkeitsbilanz \u2014 was rein kommt und was raus geht",
        body: "",
        glossarBegriffe: ["Perspiratio", "Einfuhr", "Ausfuhr"],
      },
      inlineWissen: {
        bausteinRef: "pflegeprozess-flüssigkeitsbilanz",
        storyAufhaenger: "Drei Begriffe für die Flüssigkeitsbilanz: Einfuhr, Ausfuhr, Perspiratio.",
        storyAufhaengerB1: "Drei Begriffe für die Berechnung.",
        kerntext: "**Einfuhr** = Flüssigkeit die reinkommt: Trinken, Infusionen, flüssige Nahrung.\n\n**Ausfuhr** = Flüssigkeit die rausgeht: Urin, Stuhl, Erbrechen.\n\n**Perspiratio insensibilis** = unsichtbarer Wasserverlust ueber Haut und Atmung. Ca. 700-1000 ml/Tag. Bei Fieber höher.\n\n**Bilanz** = Einfuhr minus Ausfuhr (inkl. Perspiratio). Negativ = Defizit = Exsikkose-Risiko.",
        ...
        karteikarte: {
          ...
          rueckseite: "1000 - 1550 = -550 ml Defizit. Perspiratio = unsichtbarer Wasserverlust. Maßnahme: Trinkmenge erhöhen.",
        },
      },
    },
    ...
    {
      stepId: "ce02-baür-eval-06-exsikkose-bilanz",
      phase: 5,
      ...
      contentB1: {
        title: "Wie viel Flüssigkeit hat Herr Baür heute?",
        body: "Berechne: Herr Baür hat heute getrunken: 200 ml + 400 ml + 400 ml = 1000 ml. Sein Körper hat verloren: ca. 750 ml Urin + ca. 800 ml durch die Haut und Atmung (Schätzung Lehrbuch) = 1550 ml. Bilanz = Was rein kommt minus was raus geht. Was bedeutet das?",
      ...
      question: {
        ...
        calculation: {
          ...
          tolerance: 0,
          explanation:
            "Bilanz = 1000 − 1550 = −550 ml. Negative Bilanz bedeutet: Herr Baür verliert deutlich mehr als er aufnimmt. Morgen muss die Trinkmenge erhöht werden — Ziel 1500 ml. Ein Defizit dieser Größe über mehrere Tage = Exsikkoserisiko.",
          explanationB1:
