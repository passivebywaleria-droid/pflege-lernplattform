  ...
  kernSteps: [
    ...
    // Was macht das mit dem Koerperschema? Warum beruhigt das bei Demenz?
    {
      ...
      contentC1: {
        ...
        body: "",
        glossarBegriffe: ["Körperschema", "Propriozeption", "Haarwuchsrichtung", "Autonomie", "Deeskalation", "Handführung", "Ressource", "Ressourcen", "Wuerde", ],
      },
      contentB1: {
        title: "Warum in Haarrichtung waschen?",
        body: "",
        glossarBegriffe: ["Körperschema", "Haarwuchsrichtung"],
      },
      inlineWissen: {
        bausteinRef: "ganzkörperpflege-haarwuchsrichtung-körperschema",
        storyAufhaenger:
          "Du hast gerade gelesen: beruhigende Waschung geht in Haarwuchsrichtung. Aber warum genau? Was passiert im Körper wenn du von der Schulter zur Hand wäschst — und was passiert wenn du es umgekehrt machst?",
        storyAufhaengerB1:
        ...
        spektrum: [
          {
            ...
            kurzbeschreibung:
              "Bei Frau M. hilft beruhigende Waschung gegen den erhöhten Muskeltonus (Rigor bei Parkinson). Haarwuchsrichtung: Muskeltonus sinkt, Bewegung wird leichter — günstiger Moment für Transfer.",
          },
          {
            ...
            kurzbeschreibung:
              "Bei Neglect nach Schlaganfall: Die vergessene Körperseite gezielt in Haarwuchsrichtung waschen — somatische Stimulation hilft dem Gehirn, die betroffene Seite wieder wahrzunehmen.",
          },
          {
...
// Step 4.2 — Branching: KOMPLIKATION 1 — Abwehr bei Pflege
    ...
    // Ausfuehrung der passiven Kniebewegung bei einem Patienten der sich wehrt.
    {
      ...
      transition: "Passive Bewegung vorbereitet. Jetzt: Die richtige Reihenfolge der Übungen.",
      contentC1: {
      ...
      inlineWissen: {
        ...
        faustregel:
          "Passive Bewegung bei Demenz: in die Pflege integrieren, nicht als extra Übung. Die Waschung oeffnet die Tuer — die Bewegung nutzt den Moment.",
        faustregelB1:
        ...
        spektrum: [
          {
            ...
            kurzbeschreibung:
              "Bei Hemiparese: passive/aktiv-assistive Bewegung nach Bobath-Konzept — die gelähmte Seite wird in alltagsnahe Bewegungen integriert (z. B. Arm führen beim Waschen). Ziel: kortikale Reorganisation, nicht nur Kontraktur-Prävention.",
          },
          {
            ...
            kurzbeschreibung:
              "Nach Hüft-TEP: Physiotherapie führt aktiv-assistive Übungen ab Tag 1 (CPM-Schiene, isometrische Übungen). Pflege unterstützt mit Lagerung und Motivation — aber die Bewegungsführung liegt beim Physio.",
          },
          {
            patientName: "Frau Kovac",
            situationsId: "ls-kovac-ambulant",
            ...
            kurzbeschreibung:
              "Ambulant: Frau Kovac vermeidet Bewegung aus Angst vor Atemnot (Dyspnoe-Spirale). Kontrakturrisiko Sprunggelenk. Lösung: Atemtechniken + Bewegung kombinieren — 'beim Ausatmen bewegen'.",
          },
        ],
        karteikarte: {
          vorderseite:
        ...
        sequencing: {
          ...
          items: [
            ...
            },
            {
              id: "e4",
              label:
                "Ferse unterpolstern (Lagerungsrolle unter den Unterschenkel, Ferse frei — Eigengewicht fördert Streckung)",
            },
          ],
        },
      },
    ...
    // Inline-Wissen: Mobilisation bei Abwehr \u2014 Patientenwille und Verhaeltnismaessigkeit
    {
      ...
      transition: "Mobilisation, Patientenwille, Verhältnismässigkeit \u2014 jetzt die Entscheidung.",
      contentC1: {
        title: "Mobilisation bei Abwehr \u2014 Patientenwille und Verhältnismässigkeit",
        body: "",
        glossarBegriffe: ["Mobilisation", "Abwehr", "Patientenwille", "Selbstbestimmung", "Verhältnismässigkeit"],
      },
      contentB1: {
