...
Der Raum ist vorbereitet: warm und ruhig. Das Licht ist voll an — du brauchst gute Sicht für die Hautinspektion und den Verletzungs-Check (DNQP Sturzprophylaxe 2022). Erst nach abgeschlossener Inspektion reduzierst du das Licht für die beruhigende Waschung (Bienstein/Fröhlich 2021). Herrn Bauers Lieblingsmusik läuft leise im Hintergrund (Freddy Quinn, "Junge komm bald wieder"). Du trägst Einmalhandschuhe und hast alles bereit.
...
|---|---------|----------|-------|--------|-----|
| 4.1 | `dur-01-basale-vorbereitung` | **text** (displayFormat: `stepbystep`) | B3 | Erklär-Step: Was versteht man unter einer "beruhigenden Ganzkörperwaschung" im Sinne der Basalen Stimulation? 5 Schritte: 1) Innerhalb jeder Körperregion in Haarwuchsrichtung streichen (Körperschema aktivieren — z. B. von Schulter zur Hand, von Hüfte zum Fuß), 2) Körpertemperatur angepasstes Wasser, 3) **Reihenfolge der Körperregionen folgt der Hygiene: vom sauberen zum unreinen Bereich** (Gesicht/Augen zuerst, Genital-/Analbereich zuletzt) — die Stimulationsrichtung "peripher nach zentral" gilt für die Strichführung innerhalb einer Region, nicht für die Gesamt-Reihenfolge, 4) Ankündigen jeden Handgriffs kurz und ruhig, 5) Pausieren wenn Abwehr kommt — nie gegen Widerstand. Quelle: _(Bienstein C./Fröhlich A., 2021; I Care Pflege, Kap. Körperpflege)_. **Trigger für Baustein `basale-stimulation-beruhigende-waschung` Stufe 2–3 bei niedrigem Profil.** | pflege |
...
| 4.4 | `dur-04-bewegungsuebungen` | **sequencing** | B4 | Nach der Körperpflege, Herr Bauer liegt entspannt. Jetzt: Bewegungsübungen für Knie + Sprunggelenk. Sortiere die Übungsreihenfolge: [Füße kreisen lassen (aktiv-assistiv)] → [Passive Knieflexion im Bett (Beugung im Kniegelenk, bis zur schmerzfreien Grenze — BESD beachten)] → [Spitzfußprophylaxe: Fußsohle gegen weiches Brett stellen] → [Kniegelenk in Neutralstellung auspolstern (Lagerungsrolle)]. Wichtig: Jede Übung kurz ankündigen, Pause bei Abwehr. **Trigger für Baustein `kontraktur-prophylaxe-passiv-aktivdurchbewegen` Stufe 2–3 bei <3 korrekt.** | anatomie |
| 4.5 | `dur-05-mundpflege` | **mc** (Single-Choice) | B4 | Herr Bauer trinkt wenig — seine Mundschleimhaut ist trocken. Welche Mundpflegeintervention ist bei einem Menschen mit Demenz und Trinkverweigerung am besten geeignet? A) Mundspülung mit Chlorhexidin 3× täglich. B) Mundschwämmchen mit festsitzendem Kopf, sanft auf die Schleimhaut anwenden — Pflegekraft führt, Patient nicht alleine lassen; geringes Aspirationsrisiko bei sachgerechter Anwendung (FDA-Warnung 2017 zu Schwämmchen mit losem Kopf beachten). ✅ C) Zähne zweimal täglich bürsten mit Fluorid-Creme, auch wenn er sich wehrt. D) Ausreichend trinken — wenn er nicht trinkt, kann man nichts machen. **Richtig: B.** Feedback bei C: Zwang bei Mundpflege → Aspiration/Schlucken-Gefahr + Würde. Feedback bei A: Chlorhexidin ist Arzneimittel, nicht Standard-Mundpflege. Quelle: _(DNQP Mundpflege 2023)_. **Trigger für Baustein `mundpflege-soor-prophylaxe` Stufe 2.** | pflege |
