  ...
  kernSteps: [
    // Step 1.1 — SBAR-Übergabe (scenario)
    {
      ...
      contentC1: {
        ...
        body: "Du nimmst kurz die Aufnahmedokumentation zur Hand.\n\nEmilia K., 4 Monate, 5,6 kg. Diagnose: Bronchiolitis RSV. Mutter stillt vollständig. Fieber 38,2 °C bei Aufnahme um 03:15 Uhr. Die Pflegeübergabe folgt der **SBAR**-Struktur (**SBAR** = strukturiertes Übergabe-Schema mit vier Punkten): **S** = Säugling mit Trinkschwäche und Fieber, bisher 3 nasse Windeln in 12 Stunden. **B** = bisher gesundes Kind, Erstgebärende 24 Jahre, allein erziehend. **A** = leicht erhöhte **Atemfrequenz** (= Atemzüge pro Minute), noch kein Sauerstoffbedarf, Turgor noch erhalten. **R** = **Flüssigkeit**sstatus engmaschig überwachen, Mutter begleiten.\n\n**Übergabe** = die strukturierte Weitergabe von Patient-Informationen zwischen zwei Pflegekräften oder Schichten. **Assessment** = die fachliche Einschätzung des aktuellen Zustands. Du liest die Übergabe — und betrittst dann das Zimmer.",
        fallbezug:
        ...
        glossarBegriffe: ["Bronchiolitis", "RSV", "SBAR", "Tachypnoe", "Übergabe", "Assessment", "Flüssigkeit", "Atemfrequenz"],
      },
      contentB1: {
        title: "Aufnahmedokumentation lesen",
        body: "Du liest die Übergabe.\n\n**Übergabe** = wenn eine Pflegekraft einer anderen erzählt, wie es dem Patienten geht. Hier folgt die Übergabe der **SBAR**-Struktur (**SBAR** = ein Übergabe-Schema mit 4 Schritten):\n\n**S** = Situation: Emilia trinkt wenig. Sie hat Fieber. Nur 3 nasse Windeln in 12 Stunden.\n**B** = Background (= Hintergrund): Emilia war bisher gesund.\n**A** = **Assessment** (= Einschätzung): Emilia atmet etwas schnell. Sie braucht noch keinen Sauerstoff. Turgor (= Hautspannung) ist noch normal.\n**R** = Recommendation (= Empfehlung): Beobachte die **Flüssigkeit** sehr regelmäßig (= engmaschig).\n\n**Atemfrequenz** = wie oft Emilia pro Minute atmet. Danach gehst du ins Zimmer.",
        fallbezug:
        ...
        glossarBegriffe: ["Bronchiolitis", "RSV", "SBAR", "Übergabe", "Assessment", "Flüssigkeit", "Atemfrequenz"],
      },
    },
        ...
        dialogPhases: [
          {
            ...
            options: [
              ...
              },
              {
                ...
                feedbackB1:
                  "Du willst Laura schnell beruhigen — das ist ein guter Reflex. Aber stattdessen wirkt es entwertend, weil du Emilia noch nicht angeschaut hast und 'keine Sorge' sagt: Deine Sorge ist falsch. Beim nächsten Mal: erst Laura ernst nehmen, dann untersuchen, dann einschätzen.",
              },
              {
          ...
          },
          {
            ...
            contextB1:
              "Laura antwortet. Du sammelst Informationen. Dann sagt sie:\n\n\"Früher hat sie getrunken bis ich dachte, sie platzt. Jetzt lässt sie nach drei Schlucken los.\"",
            speaker: "Laura K.",
            options: [
              {
    ...
    // Step 1.4 — Sorting: Anamnesefragen priorisieren
    {
      ...
      contentC1: {
        ...
        body: "**ABCDE** = ein klinisches Schema zur Priorisierung in der Notfallmedizin (A = Airway/Atemweg, B = Breathing/Atmung, C = Circulation/Kreislauf, D = Disability/Bewusstsein, E = Exposure/Untersuchung). Du sammelst beim Aufnahmegespräch Informationen. Bringe die Fragen in eine pflegerisch sinnvolle Priorisierung. Logik: Wir starten beim Hauptbeschwerden-Leitsymptom (hier Trinkschwäche, weil die Atmung makroskopisch noch unauffällig ist — keine Einziehungen, keine Tachypnoe > 60/min). Bei kritischer Atemnot würde nach ABCDE die Atmung höher priorisiert.",
        glossarBegriffe: ["ABCDE"],
      },
      contentB1: {
        title: "Welche Fragen sind am wichtigsten?",
        body: "**ABCDE** = ein Schema in der Notfall-Pflege. Es heißt: A (Atemweg), B (Atmung), C (Kreislauf), D (Bewusstsein), E (Untersuchung). So bestimmt man die Reihenfolge bei einem Notfall. Du sammelst Informationen. Bringe die Fragen in eine sinnvolle Reihenfolge. Hier startest du beim Hauptproblem: Trinkschwäche. Die Atmung ist im Moment noch okay (keine Einziehungen, Atemfrequenz im Normbereich). Wenn Emilia stark atemnot wäre, müsste die Atmung höher priorisiert werden (ABCDE).",
        glossarBegriffe: ["ABCDE"],
      },
      question: {
        fragetext:
          "Bringe die Anamnesefragen in eine pflegerisch sinnvolle Priorisierung.",
        sortItems: [
    ...
    // Step 1.5 — Text (quote): Stillen-Zitat und Information
    {
      ...
      contentC1: {
        ...
        glossarBegriffe: ["Obligate Nasenatmer", "Antikörper", "Bronchiolitis", "Trinken", "Problem"],
      },
      contentB1: {
        title: "Lauras Frage zum Stillen",
  ...
  optionaleSteps: [
    ...
    // Step 1.7 — Text (stepbystep): SBAR erklärt
    {
      ...
      contentC1: {
        ...
        glossarBegriffe: ["SBAR", "Übergabe", "Assessment", "Problem"],
      },
      contentB1: {
        title: "SBAR — das Übergabe-Schema",
    ...
    // Step 1.8 — Text (analogy): Obligate Nasenatmer erklärt
    {
      ...
      contentC1: {
        ...
        glossarBegriffe: ["Obligate Nasenatmer", "Trinken", "Problem"],
      },
      contentB1: {
