...
export const CE02_SIT_NGUYEN_STOMA_PATIENT: PatientBeschreibung = {
  ...
  hintergrundB1:
    "Herr Nguyen kam 1985 aus Vietnam nach Deutschland. Er war Koch. Er hatte ein Restaurant. Das Restaurant wurde vor 3 Jahren übergeben. Herr Nguyen spricht einfaches Deutsch. Fach-Wörter versteht er kaum. Er braucht seine Tochter Linh als Übersetzerin. Herr Nguyen hat jetzt ein Stoma (= eine Öffnung am Bauch). Der Darm kommt durch die Bauch-Wand nach außen. Der Stuhl kommt in einen Beutel. Herr Nguyen kann das nicht kontrollieren. Das ist schwer für ihn. Er sagt leise: 'Ich bin kein richtiger Mann mehr.' Er spricht nicht viel über seine Gefühle. Seine Frau Mai spricht kein Deutsch. Sie sitzt neben dem Bett. Sie hat Angst. Wichtig: Herr Nguyen lernt den Beutelwechsel selbst — er ist der Patient. Mai schaut zu und hilft nur, wenn er nicht kann. Das nimmt Mai Druck. Wichtig: Du schaust immer Herrn Nguyen an. Er ist der Patient.",
  persoenlichkeit:
