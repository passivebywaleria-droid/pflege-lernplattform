      ...
      question: {
        ...
        optionen: [
          ...
          },
          {
            ...
            isCorrect: true,
            explanation:
              "Richtig. Wenn die Bauchdecke wegen Wunde + Stoma nicht sicher nutzbar ist, weicht man auf alternative Standardorte aus: laterale Oberschenkelaußenseite (für NMH freigegeben) oder kontralateraler Oberbauch. Abstände: um den Nabel mind. 2 cm frei lassen (Pflege heute) und ≥5 cm zu OP-Naht und Stoma. Injektionsorte werden in alternierenden Quadranten rotiert (z.B. Tag 1 rechts oben, Tag 2 links oben, Tag 3 rechts unten, Tag 4 links unten — bei Herrn Nguyen: Bauchdecke gemieden, also Oberschenkel-Quadranten rotieren). Gereizte oder hämatombelastete Stellen meiden. Quelle: Pflege heute 7. Aufl. Kap. 43.4.3; AWMF S3-Leitlinie VTE-Prophylaxe.",
            explanationB1:
