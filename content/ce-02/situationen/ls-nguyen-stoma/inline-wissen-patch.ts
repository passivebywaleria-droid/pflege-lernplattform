...
export const CE02_NGUYEN_IWP_02_THROMBOSE_HEPARIN: ContentStep = {
  ...
  kompetenzbereich: "I.1",
  quellen: [
    "AWMF S3-Leitlinie (2015): Prophylaxe der venösen Thromboembolie (VTE)",
...
export const CE02_NGUYEN_IWP_04_MANGELERNAEHRUNG: ContentStep = {
  stepId: "ce02-nguyen-beob-03c-mangelernaehrung",
  phase: 2,
  stepType: "inlineWissen",
  bloomLevel: 2,
  kompetenzbereich: "I.1",
  ...
  track: "basis",
  modus: "entdecker",
  lernziel: "ce02-nguyen-beob-mangelernaehrung",
  tag: "pflege",
  ...
  inlineWissen: {
    bausteinRef: "ernaehrungsassessment-nrs2002-post-op",
    themaPrimaer: "ernaehrungsassessment",
    storyAufhaenger:
...
export const CE02_NGUYEN_IWP_07_WUERDE_EMPOWERMENT: ContentStep = {
  stepId: "ce02-nguyen-dur-00b-wuerde-empowerment",
  phase: 4,
  stepType: "inlineWissen",
  bloomLevel: 2,
  ...
  track: "basis",
  modus: "entdecker",
  lernziel: "ce02-nguyen-dur-wuerde-empowerment",
  tag: "pflege",
  themaPrimaer: "pflegeprozess",
  themenSekundaer: ["stuhlausscheidung"],
  transition:
  ...
  inlineWissen: {
    bausteinRef: "pflegeprozess-wuerde-empowerment-stoma",
    themaPrimaer: "pflegeprozess",
    storyAufhaenger:
...
export const CE02_NGUYEN_IWP_10_ERNAEHRUNGSPROTOKOLL: ContentStep = {
  stepId: "ce02-nguyen-dok-01b-ernaehrungsprotokoll",
  phase: 6,
  stepType: "inlineWissen",
  bloomLevel: 2,
  kompetenzbereich: "I.1",
  ...
  track: "basis",
  modus: "entdecker",
  lernziel: "ce02-nguyen-dok-ernaehrungsprotokoll",
  tag: "pflege",
  themaPrimaer: "ernaehrungsassessment",
  ...
  inlineWissen: {
    bausteinRef: "ernaehrungsassessment-dokumentation-stoma",
    themaPrimaer: "ernaehrungsassessment",
    storyAufhaenger:
