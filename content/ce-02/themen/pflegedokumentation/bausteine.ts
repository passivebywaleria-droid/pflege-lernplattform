...
export const CE02_THEMA_PFLEGEDOKUMENTATION_BAUSTEINE: Wissensbaustein[] = [
  ...
  // ═══════════════════════════════════════════
  {
    ...
    stufe1: {
      ...
      antwort:
        "Fehler: (1) 'typisch für ihn' = Persönlichkeitsurteil, (2) 'gerast' = unsachlich, (3) 'hört nicht zu' = Urteil statt Beobachtung, (4) 'Hätten wir...' = Spekulation gehört in Fallbesprechung, (5) Fixierungsfrage = rechtlich heikel (§ 1831 BGB). Korrekt: '15.04.2026, 9:35 Uhr: Herr S. fiel im Flur zwischen Zimmer 12 und Schwesternzimmer. Ging mit Rollator zügig. Bat ihn, langsamer zu gehen — reagierte nicht sofort. Stolperte über Türschwelle, fiel rechts. Keine sichtbaren Verletzungen, RR 130/80, Puls 78. Arzt Dr. Meyer informiert 9:40. Sturzprotokoll ausgefüllt. (Schw. Demir)'",
    },
    stufe2: {
      typ: "hinweis",
      text: "Dieser Eintrag hat **mehrere Fehler**: (1) **Wertung** ('typisch'), (2) **unsachliche Sprache** ('gerast', 'hört nicht zu'), (3) **fehlende Zeit/Fakten** (wann, wo, wie), (4) **Spekulation statt Handlung** ('Hätten wir...'), (5) **Fixierungsfrage** ist **rechtlich heikel** (§ 1831 BGB).",
      textB1:
        "Der Eintrag hat **viele Fehler**: (1) **Wertung** ('typisch'), (2) **unsachlich** ('gerast', 'hört nicht zu'), (3) **keine Zeit** oder **genaue Infos**, (4) **Frage statt Fakten** ('Hätten wir...'), (5) **Fixierung** ist **rechtlich schwierig** (§ 1831 BGB).",
    },
    stufe3: {
      typ: "erklaerung",
      step: {
        ...
        bloomLevel: 6,
        kompetenzbereich: "I.1",
        quellen: ["§ 630f BGB", "§ 267 StGB", "§ 1831 BGB", "DNQP 2022"],
        track: "basis",
        modus: "entdecker",
