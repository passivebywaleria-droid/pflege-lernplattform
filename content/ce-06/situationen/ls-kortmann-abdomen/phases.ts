  ...
  kernSteps: [
    {
      ...
      inlineWissen: {
        ...
        faustregel:
          "Über 200 ml frisches Blut aus der Drainage in der ersten postoperativen Stunde → sofort Arzt (plötzlicher starker Blutverlust ist auch später alarmierend). Drainage NICHT selbst abklemmen/ziehen, Stoma-Verfärbung beurteilt der Arzt, Herr Kortmann bleibt nüchtern (mögliche Re-OP). Du erkennst, meldest, überwachst, bereitest vor.",
        faustregelB1:
          "Über 200 ml frisches Blut aus der Drainage in der ersten Stunde nach der OP: sofort Arzt. Auch später gilt: plötzlich viel Blut = sofort Arzt. Die Drainage NICHT selbst abklemmen oder ziehen. Eine Stoma-Verfärbung beurteilt der Arzt. Herr Kortmann bleibt nüchtern, denn vielleicht folgt eine zweite OP. Du erkennst, meldest, überwachst und bereitest vor.",
        spektrum: [
          {
        ...
        karteikarte: {
          ...
          rueckseite:
            ">200 ml frisches Blut in der ersten postop Stunde → sofort Arzt (plötzlicher starker Blutverlust auch später alarmierend); Drainage NICHT selbst abklemmen/ziehen (die Blutung wird im OP gestillt). Stoma-Verfärbung (livide/grau) beurteilt der Arzt — du erkennst/meldest/beobachtest, massierst nicht. Nüchtern lassen (Re-OP möglich), Volumen/Transfusion nach Anordnung. Pflege: erkennen, melden, überwachen, vorbereiten.",
          vorderseiteB1:
            "Die Bauch-Drainage blutet, das Stoma ist verfärbt. Was ist dein Part? Was macht der Arzt?",
          rueckseiteB1:
            "Über 200 ml frisches Blut in der ersten Stunde nach der OP → sofort Arzt. Auch später gilt: plötzlich viel Blut = sofort Arzt. Die Drainage NICHT selbst abklemmen oder ziehen. Die Blutung wird im OP gestillt. Eine Stoma-Verfärbung (bläulich oder grau) beurteilt der Arzt. Du erkennst, meldest und beobachtest, aber massierst nicht. Nüchtern lassen, denn vielleicht folgt eine zweite OP. Flüssigkeit und Blutkonserven nur nach Anordnung. Deine Aufgabe: erkennen, melden, überwachen, vorbereiten.",
        },
      },
    },
    {
