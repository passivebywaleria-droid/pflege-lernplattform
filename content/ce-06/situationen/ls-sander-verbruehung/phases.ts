  ...
  kernSteps: [
    {
      ...
      contentB1: {
        title: "Wie schätzt du die Verletzung ein?",
        body: "Frau Sander hat Blasen am Unterarm und starke Schmerzen. Wie ordnest du die Verbrühung ein?",
        ...
        optionen: [
          {
            ...
            explanationB1:
              "Richtig. Die Fläche ist klein (Handfläche ≈ 1 %), ein Schock droht erst bei viel größerer Fläche. Aber eine 2.-gradige Verbrühung bei einer alten Frau muss trotzdem zum Arzt.",
          },
          {
        ...
        optionen: [
          {
            ...
            isCorrect: true,
            explanation:
              "Richtig. Die formalen Schwellen für eine Klinik- oder Zentrumsbehandlung sind eine Fläche über 10 % der Körperoberfläche bzw. Verbrennungen im Gesicht, an Händen, Füßen oder im Genitalbereich — die erfüllt Frau Sander mit ihrer kleinflächigen Verbrühung nicht. Trotzdem ist eine offene, blasenbildende (zweitgradige) Wunde bei einer allein lebenden 74-Jährigen ein Fall für ärztliche Beurteilung: wegen der Schmerzen, der fachgerechten Wundversorgung und der Infektionsgefahr. Du organisierst deshalb zeitnah ärztliche Hilfe, versorgst parallel die Wunde und informierst — im ambulanten Dienst — Angehörige und den Pflegedienst.",
            explanationB1:
              "Richtig. Eine 2.-gradige Verbrühung mit Blasen bei einer alten Frau muss zeitnah ärztlich versorgt werden. Du holst Hilfe (Rettungsdienst/Notaufnahme) und versorgst gleichzeitig die Wunde.",
          },
          {
        ...
        optionen: [
          {
            ...
            explanationB1:
              "Richtig. Vollständiges SBAR: was/wann, Vorgeschichte, Zustand (Grad, Fläche, was schon getan wurde, Schmerz), und die Bitte (Schmerzmittel, Transport). Alles Wichtige in Sekunden.",
          },
          {
