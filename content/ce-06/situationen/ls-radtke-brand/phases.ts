  ...
  kernSteps: [
    {
      ...
      question: {
        ...
        optionen: [
          {
            text: "Ein Massenanfall von Verletzten (MANV): mehr Betroffene, als mit den vorhandenen Kräften individuell versorgt werden können. Das Leitprinzip lautet, für möglichst viele das Beste zu tun.",
            isCorrect: true,
            explanation:
