        ...
        trueFalseCards: [
          {
            ...
            isTrue: false,
            explanation:
              "Falsch. Sauerstoffgabe und Nitroglyzerin werden nur auf ärztliche Anordnung verabreicht — nicht eigenmächtig; Sauerstoff ist beim akuten Koronarsyndrom zudem erst bei einer Sättigung unter 90 % vorgesehen, deshalb wird sie per Pulsoximetrie überwacht. Dass ihr Nitrospray diesmal keine wesentliche Schmerzlinderung gebracht hat, ist gerade das Warnzeichen für einen Infarkt (nicht 'nur die Angina'). Und Nitro senkt den Blutdruck: Fällt er ab, kann eine erneute Gabe den Kreislauf gefährlich weiter absenken — gegeben wird es nur bei ausreichendem Blutdruck. Deine Aufgabe: erkennen, lagern, überwachen, dokumentieren, Arzt informieren — und ärztliche Anordnungen umsetzen.",
            explanationB1:
              "Falsch. Sauerstoff und Nitro gibt die Pflege nur auf Anordnung vom Arzt — nicht von sich aus. Sauerstoff ist erst geplant, wenn die Sättigung unter 90 % fällt. Darum misst man sie mit dem Pulsoximeter. Dass ihr Nitrospray diesmal nicht richtig geholfen hat, ist genau das Warnzeichen für einen Infarkt (nicht nur ihre Angina). Und Nitro senkt den Blutdruck: Wenn er fällt, kann noch mehr Nitro den Kreislauf gefährlich weiter absenken. Nitro gibt man nur, wenn der Blutdruck hoch genug ist. Deine Aufgabe: erkennen, lagern, überwachen, aufschreiben, den Arzt informieren — und seine Anordnungen umsetzen.",
          },
        ],
      },
    },
