        ...
        optionen: [
          {
            ...
            isCorrect: true,
            explanation:
              "Richtig. Bei starker Blutung entsteht ein hypovolämischer Schock (Volumenmangelschock). Die Leitsymptome sind genau das, was du siehst: ein schneller (über 100/min), schwächer werdender Puls, ein sinkender systolischer Blutdruck, kalte blasse Haut mit feinperligem Schweiß, Unruhe. Sein 'normaler' Blutdruck ist hyperton — 100/70 ist für ihn schon ein Abfall. Der Schockindex (Puls geteilt durch systolischen Blutdruck) liegt hier bei 108/100 ≈ 1,1 — ein Wert über 1 bedeutet Schockgefahr bis Schock.",
            explanationB1:
              "Richtig. Durch den Blutverlust entsteht ein hypovolämischer Schock (ein Volumenmangelschock). Die Zeichen: schneller, schwacher Puls, fallender Blutdruck, kalte blasse Haut mit Schweiß, Unruhe. Sein Blutdruck ist normal sehr hoch — 100/70 ist für ihn schon zu niedrig. Der Schockindex (Puls geteilt durch den oberen Blutdruckwert) ist hier 108 geteilt durch 100 — also etwa 1,1. Über 1 heißt: Schockgefahr oder Schock.",
          },
          {
  ...
  kernSteps: [
    {
      ...
      kompetenzbereich: "I.4",
      quellen: [
        "Pflege heute 2019, Kap. 14.5.1/14.5.2",
        // Text-Audit F-03 (2026-07-19): Beleg für erhöhten Oberkörper bei wachem
        // Hämatemesis-Patienten nachgetragen — „Die Betroffene in sitzende
        // Position bringen, Bewusstlose in stabile Seiten- und Schocklage."
        "I care Pflege 3. Aufl., Kap. 23.5.5.2 (Hämatemesis: sitzende Position, Bewusstlose stabile Seitenlage)",
      ],
      track: "basis",
      modus: "entdecker",
        ...
        optionen: [
          {
            ...
            isCorrect: true,
            explanation:
              "Richtig. Im Schock ist der Sauerstoffbedarf hoch; die einfache Sauerstoffmaske ermöglicht eine höhere Dosierung von 5–10 l/min, im Schock werden häufig 6–8 l/min gegeben. Wichtig: Bei der Maske darf der Fluss nicht unter 5 l/min absinken, sonst droht ein CO2-Stau in der Maske. Reicht das nicht, gibt es eine Steigerung: Masken mit Reservoirbeutel erreichen noch höhere Sauerstoffkonzentrationen und werden in der Notfallmedizin eingesetzt. Die Gabe erfolgt auf ärztliche Anordnung.",
            explanationB1:
              "Richtig. Im Schock braucht er viel Sauerstoff. Die Maske gibt 5–10 l/min. Im Schock oft 6–8 l/min. Bei der Maske muss der Fluss mindestens 5 l/min betragen, sonst staut sich CO2. Wenn das nicht reicht: Eine Maske mit Reservoirbeutel (ein Sauerstoff-Speicherbeutel an der Maske) gibt noch mehr Sauerstoff. Der Arzt ordnet es an.",
          },
          {
