    ...
    },
    {
      ...
      inlineWissen: {
        ...
        karteikarte: {
          ...
          rueckseite:
            "Handeln. Keine Reaktion + kein ruhiges, gleichmäßiges Atmen = Herz-Kreislauf-Stillstand. Schnappen ist kein Atmen. Keine extra Zeit fürs Pulstasten — direkt in die Rettungskette.",
          vorderseiteB1:
            "Herr Wagner reagiert nicht und schnappt nur nach Luft. Handeln oder warten?",
          rueckseiteB1:
            "Handeln. Keine Reaktion + kein ruhiges, gleichmäßiges Atmen = Herz-Kreislauf-Stillstand. Schnappen ist kein Atmen. Keine extra Zeit für die Puls-Suche — sofort mit der Rettungskette starten.",
        },
      },
    },
    {
  ...
  kernSteps: [
    {
      ...
      kompetenzbereich: "I.4",
      quellen: ["ERC-Leitlinien 2021", "Prüfungswissen Pflegefachfrau, Tab. 3.22 (Überlebenskette)"],
      track: "basis",
      modus: "entdecker",
      ...
      inlineWissen: {
        ...
        // Prüfungs-Systematik korrekt getrennt (Text-Audit F-02, 2026-07-19):
        // Überlebenskette wortgetreu nach Prüfungswissen Pflegefachfrau Tab. 3.22
        // — NICHT mit den vier Handgriffen dieser Situation gleichsetzen.
        sonstBox:
          "In Prüfungen wird oft nach der Überlebenskette gefragt. Ihre vier Schritte lauten: (1) frühes Erkennen und Notruf, (2) frühe Wiederbelebung durch Notfallzeugen, (3) frühe Defibrillation, (4) frühe erweiterte Maßnahmen und Postreanimationsmanagement. Deine vier Handgriffe bei Herrn Wagner decken die ersten drei Schritte ab — Schritt 4 übernimmt das Notfallteam.",
        sonstBoxB1:
          "In Prüfungen fragt man oft nach der Überlebenskette. Ihre vier Schritte: (1) früh erkennen und Notruf, (2) frühe Wiederbelebung durch Helfer vor Ort, (3) frühe Defibrillation, (4) frühe erweiterte Maßnahmen und die Behandlung nach der Reanimation. Deine vier Handgriffe decken die Schritte 1 bis 3 ab. Schritt 4 macht das Notfallteam.",
        karteikarte: {
          vorderseite:
