...
const apiPublicPaths = ["/api/health", "/api/auth/", "/api/ki-feedback", "/api/ki-chat", "/api/erklaer-anders", "/api/tts", "/api/stt", "/api/content/", "/api/stripe/webhook", "/api/waitlist", "/api/funnel"]
