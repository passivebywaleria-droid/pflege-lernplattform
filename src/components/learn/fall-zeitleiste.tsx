...
function FallKarte({
  ...
  return (
    ...
    >
      ...
      <p className="text-xs text-[var(--lern-text-secondary)] mb-2 line-clamp-2">
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  {station.relevanteKapitel.map((kId) => (
                    <button
                      ...
                      className="inline-flex items-center gap-1 rounded-full bg-[var(--lern-accent)]/5 border border-[var(--lern-accent)]/20 px-3 py-1 text-xs font-medium text-[var(--lern-accent)] active:scale-95 transition-transform"
                    >
                      <BookOpen size={10} />
                      Kapitel lesen
                    </button>
...
export function FallZeitleiste({
  ...
  return (
    <div className="px-4 py-6" style={{ color: "var(--lern-text-primary)" }}>
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex flex-wrap gap-1.5 mt-2">
              {activeFall.patient.diagnosen.map((d) => (
                <span
                  key={d}
                  className="rounded-full bg-[#C96B5C]/10 px-2 py-0.5 text-xs font-medium text-[#C96B5C]"
                >
                  {d}
                </span>
              ))}
