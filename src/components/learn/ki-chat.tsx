  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-[96px] right-3 z-30 flex h-10 w-10 items-center justify-center rounded-full bg-[var(--lern-accent)] text-white shadow-md transition-all duration-300 active:scale-95 hover:bg-[#4C6A52] ${
