...
- [ ] **Ekel-Legitimität** „Dürfen sich Pflegende ekeln?" (LE9 E13/E14) → reflection-Step in `ls-nguyen-stoma` oder `ls-schmidt` (Ausscheidung/Intim). Quelle: pflege-konformitaet (Würde), kommunikation-Korpus. *groß im Wert, klein im Bau*
