...
Terminologie-Hinweis: Die Makro-/Mikronährstoff-Terminologie ist über Prüfungswissen und I Care Examen kompakt verbatim belegt. Der Begriff **„versteckter Hunger"** ist ein didaktischer Merkbegriff (kursiv kennzeichnen in Content).
...
**Primärquelle:** (Pflege heute Kap. 7; Atwater 1899; WHO 2015 Guideline Sugars intake)
**Beleg:**
- Quelle: `pflege-heute-volltext/pflege-heute.txt`
...
Der Schwellenwert **gesättigte Fettsäuren höchstens 10% der Kalorien** ist jetzt über Pflege heute (Kap. Fettstoffwechsel/Prävention) verbatim belegt: Fett sollte unter 30% der Kalorien liefern, davon je 10% mehrfach- und einfach ungesättigte und **höchstens 10% gesättigte Fettsäuren** (siehe Beleg).
...
Der **DGE-Richtwert ≥ 30 g/Tag** für Erwachsene ist verbatim über die DGE-D-A-CH-Referenzwerte belegt (siehe Beleg).
