...
- ⚠️ Die im Praxisfehler/M2 genannten Kontraindikationen (erhöhter Hirndruck, instabiler Kreislauf, frische HWS-Verletzung, akuter Schwindel) sind in Pflege heute Kap. 12.4 nicht als Kontraindikationen-Liste der vestibulären Stimulation ausgewiesen (2026-06-11 erneut geprüft: auch I-Care-Trilogie, Kinderkrankenpflege Kap. 6.7 und pruefungswissen ohne vestibuläre KI-Liste) → Quelle beschaffen (Bienstein/Fröhlich bzw. Nydahl/Bartoszek) ODER als allgemeine pflegerische Vorsicht ohne Quellen-Anspruch kennzeichnen.
  - TEILBELEG (Quer-Korpus 2026-06-11): Das neu erschlossene `nydahl-basale-stimulation-volltext/` (Nydahl, Technik-Übersicht 2017) nennt eine Kontraindikationen-Liste — aber für **Vibrationen** („Hypertonus, Hirndruck, Varizen") und **belebende Ganzkörperwaschung** („Hypertonus, Hirndruck"), NICHT für die vestibuläre Stimulation. „Hirndruck" als KI ist damit für verwandte Stimulationsformen verbatim gedeckt; die vestibulär-spezifische Liste (instabiler Kreislauf, frische HWS-Verletzung, akuter Schwindel) bleibt korpusweit unbelegt → ⚠️ bleibt für die vestibuläre Zuordnung ehrlich offen.
...
- `M2`: **"Vestibuläre Stimulation ist bei jedem Patienten sinnvoll"** — Kontraindikationen: erhöhter Hirndruck, instabiler Kreislauf, frische HWS-Verletzung, akuter Schwindel. Fachbegriff: "Allgemeingültigkeits-Irrtum".
