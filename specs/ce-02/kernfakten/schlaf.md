...
| geschätzteUE | 3 |
| wissensart | handlung |
| quellen | Pflege heute Kap. 11 Schlaf (lokal verbatim belegt); DGSM S3-Leitlinie Insomnie 2025 (verbatim); I Care Examen kompakt Kap. 15.6 (verbatim); Prüfungswissen Pflegefachfrau Tab. 1.39 (verbatim); Hoehl/Kullick Kinderkrankenpflege (verbatim); I Care Examen kompakt Kap. 17.3 (verbatim); I Care Pflege Tab. 15.2 (verbatim). Über dem generalistischen Ausbildungsniveau liegende Spezial-Details (STOP-BANG, ICSD-3-Nachthälften-Zuordnung als benannte Klassifikation, NSF-Spannweiten i.e.S., Beers-Liste, Sleep-Bundle-Begriff) wurden aus dem Schüler-Text gestrichen — gehören in Schlafmedizin/Schlaflabor, nicht in die generalistische Pflegeausbildung; die belegten qualitativen Aussagen bleiben erhalten |
| einträge | 13 |
| erstellt | 2026-06-10 |
| grounding | Hohe Latte (QUALITAETSSTANDARD-GROUNDING R1–R3) · alle Pflege-heute-Belege verbatim (85 Zitate) · DGSM-S3-Leitlinie 2025 verbatim (F-06, F-10, F-12, F-13) · I Care Examen kompakt + Prüfungswissen + Kinderkrankenpflege + I Care Pflege Tab. 15.2 verbatim (F-04 „Licht v. a. Taktgeber", F-05 Altersband-Spannweiten, F-07 Parasomnien-Klassifikation + zeitliche Schlafarchitektur, F-08 OSA-Symptome/ESS/nCPAP, F-13 BZ/BZRA Stürze + PRISCUS + Diphenhydramin) · Curriculum-Tiefe-Pass 2026-06-11: alle verbleibenden ⚠️ aufgelöst durch Streichung über-niveau-liegender Spezial-Details (STOP-BANG, ICSD-3-Nachthälften-Zuordnung als benannte Klassifikation, NSF-Spannweiten i.e.S., Beers-Liste, Sleep-Bundle-Begriff) — diese gehören in die Schlafmedizin/Schlaflabor, nicht in die generalistische Pflegeausbildung. Die belegten qualitativen Aussagen (zeitliche Schlafarchitektur Tiefschlaf-früh/REM-spät, Schlafmittel im Alter kritisch via PRISCUS/FORTA, OSA-Therapiestufen) bleiben erhalten. Body-⚠️ = 0 |
...
**Fakt:** Parasomnien sind störende oder krankhafte Begleiterscheinungen des Schlafs, die anfallsartig oder als Episoden auftreten (z.B. Schlafwandeln/Somnambulismus, Einnässen, Albträume, Pavor nocturnus). Die meisten dieser Symptome treten überwiegend im Kindes- und Jugendalter, im Alter oder nach Belastungssituationen auf. Pavor nocturnus = nächtliches Aufschrecken mit Angst aus dem Tiefschlaf. Schlafwandeln und Pavor nocturnus passieren im Tiefschlaf, der vor allem in der ersten Nachthälfte überwiegt; Albträume gehören in den REM-Schlaf, dessen Phasen gegen Morgen länger werden. So lassen sich diese Parasomnien zeitlich grob der frühen (Tiefschlaf) bzw. späten Nacht (REM) zuordnen.
...
- Quelle: `icare-pflege-volltext/icare-pflege.txt`
- Zitat: "Im Laufe der Nacht werden die Tiefschlafstadien kürzer und verschwinden schließlich ganz. Die REM-Phasen dagegen werden gegen Morgen länger." (I Care Pflege — belegt verbatim die zeitliche Schlafarchitektur: Tiefschlaf überwiegt in der ersten Nachthälfte, REM-Phasen nehmen gegen Morgen [zweite Nachthälfte] zu. Daraus folgt die zeitliche Zuordnung: Schlafwandeln/Pavor [Tiefschlaf] eher früh, Albträume [REM] eher gegen Morgen.)

**Misconceptions:**
- `M1`: **"Albträume und Schlafwandeln sind dasselbe"** — Schlafwandeln passiert im Tiefschlaf (NREM), Albträume im REM. Belegt: Pflege heute „Pavor nocturnus aus dem Tiefschlaf" + I Care Pflege „Tiefschlaf in der ersten Nachthälfte, REM-Phasen gegen Morgen länger" — daraus folgt, dass Schlafwandeln/Pavor eher früh, Albträume eher gegen Morgen auftreten. Fachbegriff: "Parasomnien-Verwechslung".
...
- `M3`: **"Diphenhydramin ist frei verkäuflich und deshalb sicher bei Älteren"** — Diphenhydramin (z.B. Vivinox Sleep) ist rezeptfrei erhältlich, aber antihistaminerg/anticholinerg und verursacht Überhang. Bei älteren Menschen können Nebenwirkungen nicht mehr gut kompensiert werden. icare-examen-kompakt belegt Diphenhydramin als Beispiel der Antihistaminika-Schlafmittel. Fachbegriff: "OTC-Sicherheits-Trugschluss".
